...
// Camera (orthographic)
export const CAMERA_FRUSTUM_SIZE = 7 // half-height in world units
export const CAMERA_POSITION = { x: 0, y: 9, z: -6.5 } as const
export const CAMERA_LOOK_AT = { x: 0, y: 0, z: -0.3 } as const
