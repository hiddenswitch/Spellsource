...
export type GameEvent = {
  ...
  performedGameAction?: Maybe<PerformedGameActionEvent>;
  source?: Maybe<Entity>;
  target?: Maybe<Entity>;
...
export type GameState = {
  ...
  hasPowerHistory: Scalars['Boolean'];
  isLocalPlayerTurn: Scalars['Boolean'];
  powerHistory?: Maybe<Array<GameEvent>>;
...
export type MutationConnectToGameArgs = {
  playerKey?: InputMaybe<Scalars['String']>;
  playerSecret?: InputMaybe<Scalars['String']>;
};
...
export type PerformedGameActionEvent = {
  __typename?: 'PerformedGameActionEvent';
...
export type ResolversTypes = {
  ...
  PerformedGameActionEvent: ResolverTypeWrapper<Partial<PerformedGameActionEvent>>;
...
export type ResolversParentTypes = {
  ...
  PerformedGameActionEvent: Partial<PerformedGameActionEvent>;
...
export type GameEventResolvers<ContextType = any, ParentType extends ResolversParentTypes['GameEvent'] = ResolversParentTypes['GameEvent']> = {
  ...
  performedGameAction?: Resolver<Maybe<ResolversTypes['PerformedGameActionEvent']>, ParentType, ContextType>;
...
export type GameStateResolvers<ContextType = any, ParentType extends ResolversParentTypes['GameState'] = ResolversParentTypes['GameState']> = {
  ...
  hasPowerHistory?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  isLocalPlayerTurn?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  powerHistory?: Resolver<Maybe<Array<ResolversTypes['GameEvent']>>, ParentType, ContextType>;
...
export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  ...
  connectToGame?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, Partial<MutationConnectToGameArgs>>;
...
export type PerformedGameActionEventResolvers<ContextType = any, ParentType extends ResolversParentTypes['PerformedGameActionEvent'] = ResolversParentTypes['PerformedGameActionEvent']> = {
...
export type Resolvers<ContextType = any> = {
  ...
  PerformedGameActionEvent?: PerformedGameActionEventResolvers<ContextType>;
...
export type ArtFragment = { __typename?: 'Art', body?: { __typename?: 'ArtFont', vertex?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null } | null, highlight?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, loop?: { __typename?: 'ArtPrefab', named?: string | null } | null, missile?: { __typename?: 'ArtPrefab', named?: string | null } | null, onCast?: { __typename?: 'ArtPrefab', named?: string | null } | null, onHit?: { __typename?: 'ArtPrefab', named?: string | null } | null, primary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, secondary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, shadow?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, spell?: { __typename?: 'ArtPrefab', named?: string | null } | null, sprite?: { __typename?: 'ArtSprite', named?: string | null } | null, spriteShadow?: { __typename?: 'ArtSprite', named?: string | null } | null };

export type CardFragment = { __typename?: 'Card', id: string, createdBy: string, cardScript?: any | null, blocklyWorkspace?: any | null };

export type CardRecordFragment = { __typename?: 'CardRecord', id: any, cardId?: string | null, userId?: string | null, count: number, collectionIds: Array<string>, entity: { __typename?: 'Entity', id: number, name: string, description: string, cardId: string, cardType: CardType, entityType: EntityType, rarity: Rarity, owner: number, manaCost?: number | null, baseManaCost?: number | null, attack?: number | null, baseAttack?: number | null, hp?: number | null, baseHp?: number | null, maxHp?: number | null, armor?: number | null, playable: boolean, taunt: boolean, charge: boolean, rush: boolean, divineShield: boolean, stealth: boolean, lifesteal: boolean, poisonous: boolean, deathrattles: boolean, battlecry: boolean, windfury: boolean, collectible: boolean, heroClasses: Array<string>, tribes: Array<string>, art?: { __typename?: 'Art', body?: { __typename?: 'ArtFont', vertex?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null } | null, highlight?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, loop?: { __typename?: 'ArtPrefab', named?: string | null } | null, missile?: { __typename?: 'ArtPrefab', named?: string | null } | null, onCast?: { __typename?: 'ArtPrefab', named?: string | null } | null, onHit?: { __typename?: 'ArtPrefab', named?: string | null } | null, primary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, secondary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, shadow?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, spell?: { __typename?: 'ArtPrefab', named?: string | null } | null, sprite?: { __typename?: 'ArtSprite', named?: string | null } | null, spriteShadow?: { __typename?: 'ArtSprite', named?: string | null } | null } | null } };
...
export type EntityFragment = { __typename?: 'Entity', boardPosition: number, baseAttack?: number | null, baseHp?: number | null, baseManaCost?: number | null, durability?: number | null, spellDamage?: number | null, overload?: number | null, extraAttack?: number | null, mana: number, maxMana: number, lockedMana: number, cannotAttack: boolean, chooseOne: boolean, combo: boolean, conditionMet: boolean, deflect: boolean, destroyed: boolean, discarded: boolean, enraged: boolean, frozen: boolean, gameStarted: boolean, gold: boolean, hostsTrigger: boolean, immune: boolean, isStartingTurn: boolean, permanent: boolean, roasted: boolean, silenced: boolean, summoningSickness: boolean, uncensored: boolean, underAura: boolean, untargetableBySpells: boolean, charges?: number | null, countUntilCast?: number | null, fires?: number | null, host: number, cardSet: string, cardSets: Array<string>, enchantmentType: string, note: string, id: number, name: string, description: string, cardId: string, cardType: CardType, entityType: EntityType, rarity: Rarity, owner: number, manaCost?: number | null, attack?: number | null, hp?: number | null, maxHp?: number | null, armor?: number | null, playable: boolean, taunt: boolean, charge: boolean, rush: boolean, divineShield: boolean, stealth: boolean, lifesteal: boolean, poisonous: boolean, deathrattles: boolean, battlecry: boolean, windfury: boolean, collectible: boolean, heroClasses: Array<string>, tribes: Array<string>, location?: { __typename?: 'EntityLocation', index: number, player: number, zone: Zone } | null, tooltips: Array<{ __typename?: 'Tooltip', text: string, keywords: Array<string> }>, art?: { __typename?: 'Art', body?: { __typename?: 'ArtFont', vertex?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null } | null, highlight?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, loop?: { __typename?: 'ArtPrefab', named?: string | null } | null, missile?: { __typename?: 'ArtPrefab', named?: string | null } | null, onCast?: { __typename?: 'ArtPrefab', named?: string | null } | null, onHit?: { __typename?: 'ArtPrefab', named?: string | null } | null, primary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, secondary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, shadow?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, spell?: { __typename?: 'ArtPrefab', named?: string | null } | null, sprite?: { __typename?: 'ArtSprite', named?: string | null } | null, spriteShadow?: { __typename?: 'ArtSprite', named?: string | null } | null } | null };
...
export type GameStateFragment = { __typename?: 'GameState', isLocalPlayerTurn: boolean, turnNumber: number, turnState: string, timestamp: any, hasPowerHistory: boolean, entities: Array<{ __typename?: 'Entity', boardPosition: number, baseAttack?: number | null, baseHp?: number | null, baseManaCost?: number | null, durability?: number | null, spellDamage?: number | null, overload?: number | null, extraAttack?: number | null, mana: number, maxMana: number, lockedMana: number, cannotAttack: boolean, chooseOne: boolean, combo: boolean, conditionMet: boolean, deflect: boolean, destroyed: boolean, discarded: boolean, enraged: boolean, frozen: boolean, gameStarted: boolean, gold: boolean, hostsTrigger: boolean, immune: boolean, isStartingTurn: boolean, permanent: boolean, roasted: boolean, silenced: boolean, summoningSickness: boolean, uncensored: boolean, underAura: boolean, untargetableBySpells: boolean, charges?: number | null, countUntilCast?: number | null, fires?: number | null, host: number, cardSet: string, cardSets: Array<string>, enchantmentType: string, note: string, id: number, name: string, description: string, cardId: string, cardType: CardType, entityType: EntityType, rarity: Rarity, owner: number, manaCost?: number | null, attack?: number | null, hp?: number | null, maxHp?: number | null, armor?: number | null, playable: boolean, taunt: boolean, charge: boolean, rush: boolean, divineShield: boolean, stealth: boolean, lifesteal: boolean, poisonous: boolean, deathrattles: boolean, battlecry: boolean, windfury: boolean, collectible: boolean, heroClasses: Array<string>, tribes: Array<string>, location?: { __typename?: 'EntityLocation', index: number, player: number, zone: Zone } | null, tooltips: Array<{ __typename?: 'Tooltip', text: string, keywords: Array<string> }>, art?: { __typename?: 'Art', body?: { __typename?: 'ArtFont', vertex?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null } | null, highlight?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, loop?: { __typename?: 'ArtPrefab', named?: string | null } | null, missile?: { __typename?: 'ArtPrefab', named?: string | null } | null, onCast?: { __typename?: 'ArtPrefab', named?: string | null } | null, onHit?: { __typename?: 'ArtPrefab', named?: string | null } | null, primary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, secondary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, shadow?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, spell?: { __typename?: 'ArtPrefab', named?: string | null } | null, sprite?: { __typename?: 'ArtSprite', named?: string | null } | null, spriteShadow?: { __typename?: 'ArtSprite', named?: string | null } | null } | null }>, powerHistory?: Array<{ __typename?: 'GameEvent', eventType: GameEventType, id: number, description: string, isPowerHistory: boolean, isSourcePlayerLocal: boolean, isTargetPlayerLocal: boolean, value?: number | null, source?: { __typename?: 'Entity', id: number, name: string, description: string, cardId: string, cardType: CardType, entityType: EntityType, rarity: Rarity, owner: number, manaCost?: number | null, baseManaCost?: number | null, attack?: number | null, baseAttack?: number | null, hp?: number | null, baseHp?: number | null, maxHp?: number | null, armor?: number | null, playable: boolean, taunt: boolean, charge: boolean, rush: boolean, divineShield: boolean, stealth: boolean, lifesteal: boolean, poisonous: boolean, deathrattles: boolean, battlecry: boolean, windfury: boolean, collectible: boolean, heroClasses: Array<string>, tribes: Array<string>, art?: { __typename?: 'Art', body?: { __typename?: 'ArtFont', vertex?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null } | null, highlight?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, loop?: { __typename?: 'ArtPrefab', named?: string | null } | null, missile?: { __typename?: 'ArtPrefab', named?: string | null } | null, onCast?: { __typename?: 'ArtPrefab', named?: string | null } | null, onHit?: { __typename?: 'ArtPrefab', named?: string | null } | null, primary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, secondary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, shadow?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, spell?: { __typename?: 'ArtPrefab', named?: string | null } | null, sprite?: { __typename?: 'ArtSprite', named?: string | null } | null, spriteShadow?: { __typename?: 'ArtSprite', named?: string | null } | null } | null } | null, target?: { __typename?: 'Entity', id: number, name: string, description: string, cardId: string, cardType: CardType, entityType: EntityType, rarity: Rarity, owner: number, manaCost?: number | null, baseManaCost?: number | null, attack?: number | null, baseAttack?: number | null, hp?: number | null, baseHp?: number | null, maxHp?: number | null, armor?: number | null, playable: boolean, taunt: boolean, charge: boolean, rush: boolean, divineShield: boolean, stealth: boolean, lifesteal: boolean, poisonous: boolean, deathrattles: boolean, battlecry: boolean, windfury: boolean, collectible: boolean, heroClasses: Array<string>, tribes: Array<string>, art?: { __typename?: 'Art', body?: { __typename?: 'ArtFont', vertex?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null } | null, highlight?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, loop?: { __typename?: 'ArtPrefab', named?: string | null } | null, missile?: { __typename?: 'ArtPrefab', named?: string | null } | null, onCast?: { __typename?: 'ArtPrefab', named?: string | null } | null, onHit?: { __typename?: 'ArtPrefab', named?: string | null } | null, primary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, secondary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, shadow?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, spell?: { __typename?: 'ArtPrefab', named?: string | null } | null, sprite?: { __typename?: 'ArtSprite', named?: string | null } | null, spriteShadow?: { __typename?: 'ArtSprite', named?: string | null } | null } | null } | null, targets: Array<{ __typename?: 'Entity', id: number, name: string, description: string, cardId: string, cardType: CardType, entityType: EntityType, rarity: Rarity, owner: number, manaCost?: number | null, baseManaCost?: number | null, attack?: number | null, baseAttack?: number | null, hp?: number | null, baseHp?: number | null, maxHp?: number | null, armor?: number | null, playable: boolean, taunt: boolean, charge: boolean, rush: boolean, divineShield: boolean, stealth: boolean, lifesteal: boolean, poisonous: boolean, deathrattles: boolean, battlecry: boolean, windfury: boolean, collectible: boolean, heroClasses: Array<string>, tribes: Array<string>, art?: { __typename?: 'Art', body?: { __typename?: 'ArtFont', vertex?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null } | null, highlight?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, loop?: { __typename?: 'ArtPrefab', named?: string | null } | null, missile?: { __typename?: 'ArtPrefab', named?: string | null } | null, onCast?: { __typename?: 'ArtPrefab', named?: string | null } | null, onHit?: { __typename?: 'ArtPrefab', named?: string | null } | null, primary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, secondary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, shadow?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, spell?: { __typename?: 'ArtPrefab', named?: string | null } | null, sprite?: { __typename?: 'ArtSprite', named?: string | null } | null, spriteShadow?: { __typename?: 'ArtSprite', named?: string | null } | null } | null }>, cardEvent?: { __typename?: 'CardEvent', showLocal: boolean, card?: { __typename?: 'Entity', id: number, name: string, description: string, cardId: string, cardType: CardType, entityType: EntityType, rarity: Rarity, owner: number, manaCost?: number | null, baseManaCost?: number | null, attack?: number | null, baseAttack?: number | null, hp?: number | null, baseHp?: number | null, maxHp?: number | null, armor?: number | null, playable: boolean, taunt: boolean, charge: boolean, rush: boolean, divineShield: boolean, stealth: boolean, lifesteal: boolean, poisonous: boolean, deathrattles: boolean, battlecry: boolean, windfury: boolean, collectible: boolean, heroClasses: Array<string>, tribes: Array<string>, art?: { __typename?: 'Art', body?: { __typename?: 'ArtFont', vertex?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null } | null, highlight?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, loop?: { __typename?: 'ArtPrefab', named?: string | null } | null, missile?: { __typename?: 'ArtPrefab', named?: string | null } | null, onCast?: { __typename?: 'ArtPrefab', named?: string | null } | null, onHit?: { __typename?: 'ArtPrefab', named?: string | null } | null, primary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, secondary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, shadow?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, spell?: { __typename?: 'ArtPrefab', named?: string | null } | null, sprite?: { __typename?: 'ArtSprite', named?: string | null } | null, spriteShadow?: { __typename?: 'ArtSprite', named?: string | null } | null } | null } | null } | null }> | null };
...
export type InventoryCollectionFragment = { __typename?: 'InventoryCollection', id: string, name: string, heroClass: string, format: string, deckType: DeckType, collectionType: CollectionType, userId?: string | null, isStandardDeck: boolean, inventory: Array<{ __typename?: 'CardRecord', id: any, cardId?: string | null, userId?: string | null, count: number, collectionIds: Array<string>, entity: { __typename?: 'Entity', id: number, name: string, description: string, cardId: string, cardType: CardType, entityType: EntityType, rarity: Rarity, owner: number, manaCost?: number | null, baseManaCost?: number | null, attack?: number | null, baseAttack?: number | null, hp?: number | null, baseHp?: number | null, maxHp?: number | null, armor?: number | null, playable: boolean, taunt: boolean, charge: boolean, rush: boolean, divineShield: boolean, stealth: boolean, lifesteal: boolean, poisonous: boolean, deathrattles: boolean, battlecry: boolean, windfury: boolean, collectible: boolean, heroClasses: Array<string>, tribes: Array<string>, art?: { __typename?: 'Art', body?: { __typename?: 'ArtFont', vertex?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null } | null, highlight?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, loop?: { __typename?: 'ArtPrefab', named?: string | null } | null, missile?: { __typename?: 'ArtPrefab', named?: string | null } | null, onCast?: { __typename?: 'ArtPrefab', named?: string | null } | null, onHit?: { __typename?: 'ArtPrefab', named?: string | null } | null, primary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, secondary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, shadow?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, spell?: { __typename?: 'ArtPrefab', named?: string | null } | null, sprite?: { __typename?: 'ArtSprite', named?: string | null } | null, spriteShadow?: { __typename?: 'ArtSprite', named?: string | null } | null } | null } }>, playerEntityAttributes: Array<{ __typename?: 'AttributeValueTuple', attribute: PlayerEntityAttribute, stringValue: string }>, validationReport?: { __typename?: 'ValidationReport', valid: boolean, errors: Array<string> } | null };

export type EntityLocationFragment = { __typename?: 'EntityLocation', index: number, player: number, zone: Zone };
...
export type ServerGameMessageFragment = { __typename?: 'ServerGameMessage', messageType: MessageType, id?: string | null, localPlayerId: number, isReplayMessage: boolean, changedEntityIds?: Array<number> | null, gameState?: { __typename?: 'GameState', isLocalPlayerTurn: boolean, turnNumber: number, turnState: string, timestamp: any, hasPowerHistory: boolean, entities: Array<{ __typename?: 'Entity', boardPosition: number, baseAttack?: number | null, baseHp?: number | null, baseManaCost?: number | null, durability?: number | null, spellDamage?: number | null, overload?: number | null, extraAttack?: number | null, mana: number, maxMana: number, lockedMana: number, cannotAttack: boolean, chooseOne: boolean, combo: boolean, conditionMet: boolean, deflect: boolean, destroyed: boolean, discarded: boolean, enraged: boolean, frozen: boolean, gameStarted: boolean, gold: boolean, hostsTrigger: boolean, immune: boolean, isStartingTurn: boolean, permanent: boolean, roasted: boolean, silenced: boolean, summoningSickness: boolean, uncensored: boolean, underAura: boolean, untargetableBySpells: boolean, charges?: number | null, countUntilCast?: number | null, fires?: number | null, host: number, cardSet: string, cardSets: Array<string>, enchantmentType: string, note: string, id: number, name: string, description: string, cardId: string, cardType: CardType, entityType: EntityType, rarity: Rarity, owner: number, manaCost?: number | null, attack?: number | null, hp?: number | null, maxHp?: number | null, armor?: number | null, playable: boolean, taunt: boolean, charge: boolean, rush: boolean, divineShield: boolean, stealth: boolean, lifesteal: boolean, poisonous: boolean, deathrattles: boolean, battlecry: boolean, windfury: boolean, collectible: boolean, heroClasses: Array<string>, tribes: Array<string>, location?: { __typename?: 'EntityLocation', index: number, player: number, zone: Zone } | null, tooltips: Array<{ __typename?: 'Tooltip', text: string, keywords: Array<string> }>, art?: { __typename?: 'Art', body?: { __typename?: 'ArtFont', vertex?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null } | null, highlight?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, loop?: { __typename?: 'ArtPrefab', named?: string | null } | null, missile?: { __typename?: 'ArtPrefab', named?: string | null } | null, onCast?: { __typename?: 'ArtPrefab', named?: string | null } | null, onHit?: { __typename?: 'ArtPrefab', named?: string | null } | null, primary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, secondary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, shadow?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, spell?: { __typename?: 'ArtPrefab', named?: string | null } | null, sprite?: { __typename?: 'ArtSprite', named?: string | null } | null, spriteShadow?: { __typename?: 'ArtSprite', named?: string | null } | null } | null }>, powerHistory?: Array<{ __typename?: 'GameEvent', eventType: GameEventType, id: number, description: string, isPowerHistory: boolean, isSourcePlayerLocal: boolean, isTargetPlayerLocal: boolean, value?: number | null, source?: { __typename?: 'Entity', id: number, name: string, description: string, cardId: string, cardType: CardType, entityType: EntityType, rarity: Rarity, owner: number, manaCost?: number | null, baseManaCost?: number | null, attack?: number | null, baseAttack?: number | null, hp?: number | null, baseHp?: number | null, maxHp?: number | null, armor?: number | null, playable: boolean, taunt: boolean, charge: boolean, rush: boolean, divineShield: boolean, stealth: boolean, lifesteal: boolean, poisonous: boolean, deathrattles: boolean, battlecry: boolean, windfury: boolean, collectible: boolean, heroClasses: Array<string>, tribes: Array<string>, art?: { __typename?: 'Art', body?: { __typename?: 'ArtFont', vertex?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null } | null, highlight?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, loop?: { __typename?: 'ArtPrefab', named?: string | null } | null, missile?: { __typename?: 'ArtPrefab', named?: string | null } | null, onCast?: { __typename?: 'ArtPrefab', named?: string | null } | null, onHit?: { __typename?: 'ArtPrefab', named?: string | null } | null, primary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, secondary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, shadow?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, spell?: { __typename?: 'ArtPrefab', named?: string | null } | null, sprite?: { __typename?: 'ArtSprite', named?: string | null } | null, spriteShadow?: { __typename?: 'ArtSprite', named?: string | null } | null } | null } | null, target?: { __typename?: 'Entity', id: number, name: string, description: string, cardId: string, cardType: CardType, entityType: EntityType, rarity: Rarity, owner: number, manaCost?: number | null, baseManaCost?: number | null, attack?: number | null, baseAttack?: number | null, hp?: number | null, baseHp?: number | null, maxHp?: number | null, armor?: number | null, playable: boolean, taunt: boolean, charge: boolean, rush: boolean, divineShield: boolean, stealth: boolean, lifesteal: boolean, poisonous: boolean, deathrattles: boolean, battlecry: boolean, windfury: boolean, collectible: boolean, heroClasses: Array<string>, tribes: Array<string>, art?: { __typename?: 'Art', body?: { __typename?: 'ArtFont', vertex?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null } | null, highlight?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, loop?: { __typename?: 'ArtPrefab', named?: string | null } | null, missile?: { __typename?: 'ArtPrefab', named?: string | null } | null, onCast?: { __typename?: 'ArtPrefab', named?: string | null } | null, onHit?: { __typename?: 'ArtPrefab', named?: string | null } | null, primary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, secondary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, shadow?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, spell?: { __typename?: 'ArtPrefab', named?: string | null } | null, sprite?: { __typename?: 'ArtSprite', named?: string | null } | null, spriteShadow?: { __typename?: 'ArtSprite', named?: string | null } | null } | null } | null, targets: Array<{ __typename?: 'Entity', id: number, name: string, description: string, cardId: string, cardType: CardType, entityType: EntityType, rarity: Rarity, owner: number, manaCost?: number | null, baseManaCost?: number | null, attack?: number | null, baseAttack?: number | null, hp?: number | null, baseHp?: number | null, maxHp?: number | null, armor?: number | null, playable: boolean, taunt: boolean, charge: boolean, rush: boolean, divineShield: boolean, stealth: boolean, lifesteal: boolean, poisonous: boolean, deathrattles: boolean, battlecry: boolean, windfury: boolean, collectible: boolean, heroClasses: Array<string>, tribes: Array<string>, art?: { __typename?: 'Art', body?: { __typename?: 'ArtFont', vertex?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null } | null, highlight?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, loop?: { __typename?: 'ArtPrefab', named?: string | null } | null, missile?: { __typename?: 'ArtPrefab', named?: string | null } | null, onCast?: { __typename?: 'ArtPrefab', named?: string | null } | null, onHit?: { __typename?: 'ArtPrefab', named?: string | null } | null, primary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, secondary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, shadow?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, spell?: { __typename?: 'ArtPrefab', named?: string | null } | null, sprite?: { __typename?: 'ArtSprite', named?: string | null } | null, spriteShadow?: { __typename?: 'ArtSprite', named?: string | null } | null } | null }>, cardEvent?: { __typename?: 'CardEvent', showLocal: boolean, card?: { __typename?: 'Entity', id: number, name: string, description: string, cardId: string, cardType: CardType, entityType: EntityType, rarity: Rarity, owner: number, manaCost?: number | null, baseManaCost?: number | null, attack?: number | null, baseAttack?: number | null, hp?: number | null, baseHp?: number | null, maxHp?: number | null, armor?: number | null, playable: boolean, taunt: boolean, charge: boolean, rush: boolean, divineShield: boolean, stealth: boolean, lifesteal: boolean, poisonous: boolean, deathrattles: boolean, battlecry: boolean, windfury: boolean, collectible: boolean, heroClasses: Array<string>, tribes: Array<string>, art?: { __typename?: 'Art', body?: { __typename?: 'ArtFont', vertex?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null } | null, highlight?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, loop?: { __typename?: 'ArtPrefab', named?: string | null } | null, missile?: { __typename?: 'ArtPrefab', named?: string | null } | null, onCast?: { __typename?: 'ArtPrefab', named?: string | null } | null, onHit?: { __typename?: 'ArtPrefab', named?: string | null } | null, primary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, secondary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, shadow?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, spell?: { __typename?: 'ArtPrefab', named?: string | null } | null, sprite?: { __typename?: 'ArtSprite', named?: string | null } | null, spriteShadow?: { __typename?: 'ArtSprite', named?: string | null } | null } | null } | null } | null }> | null } | null, actions?: { __typename?: 'GameActions', compatibility: Array<number>, all: Array<{ __typename?: 'SpellAction', action: number, actionType: ActionType, sourceId: number, description: string, entity?: { __typename?: 'Entity', id: number, name: string, description: string, cardId: string, cardType: CardType, entityType: EntityType, rarity: Rarity, owner: number, manaCost?: number | null, baseManaCost?: number | null, attack?: number | null, baseAttack?: number | null, hp?: number | null, baseHp?: number | null, maxHp?: number | null, armor?: number | null, playable: boolean, taunt: boolean, charge: boolean, rush: boolean, divineShield: boolean, stealth: boolean, lifesteal: boolean, poisonous: boolean, deathrattles: boolean, battlecry: boolean, windfury: boolean, collectible: boolean, heroClasses: Array<string>, tribes: Array<string>, art?: { __typename?: 'Art', body?: { __typename?: 'ArtFont', vertex?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null } | null, highlight?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, loop?: { __typename?: 'ArtPrefab', named?: string | null } | null, missile?: { __typename?: 'ArtPrefab', named?: string | null } | null, onCast?: { __typename?: 'ArtPrefab', named?: string | null } | null, onHit?: { __typename?: 'ArtPrefab', named?: string | null } | null, primary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, secondary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, shadow?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, spell?: { __typename?: 'ArtPrefab', named?: string | null } | null, sprite?: { __typename?: 'ArtSprite', named?: string | null } | null, spriteShadow?: { __typename?: 'ArtSprite', named?: string | null } | null } | null } | null, targetKeyToActions: Array<{ __typename?: 'TargetActionPair', action: number, target: number, friendlyBattlefieldIndex: number }>, choices: Array<{ __typename?: 'SpellAction', action: number, actionType: ActionType, sourceId: number, description: string, entity?: { __typename?: 'Entity', id: number, name: string, description: string, cardId: string, cardType: CardType, entityType: EntityType, rarity: Rarity, owner: number, manaCost?: number | null, baseManaCost?: number | null, attack?: number | null, baseAttack?: number | null, hp?: number | null, baseHp?: number | null, maxHp?: number | null, armor?: number | null, playable: boolean, taunt: boolean, charge: boolean, rush: boolean, divineShield: boolean, stealth: boolean, lifesteal: boolean, poisonous: boolean, deathrattles: boolean, battlecry: boolean, windfury: boolean, collectible: boolean, heroClasses: Array<string>, tribes: Array<string>, art?: { __typename?: 'Art', body?: { __typename?: 'ArtFont', vertex?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null } | null, highlight?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, loop?: { __typename?: 'ArtPrefab', named?: string | null } | null, missile?: { __typename?: 'ArtPrefab', named?: string | null } | null, onCast?: { __typename?: 'ArtPrefab', named?: string | null } | null, onHit?: { __typename?: 'ArtPrefab', named?: string | null } | null, primary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, secondary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, shadow?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, spell?: { __typename?: 'ArtPrefab', named?: string | null } | null, sprite?: { __typename?: 'ArtSprite', named?: string | null } | null, spriteShadow?: { __typename?: 'ArtSprite', named?: string | null } | null } | null } | null, targetKeyToActions: Array<{ __typename?: 'TargetActionPair', action: number, target: number, friendlyBattlefieldIndex: number }> }> }> } | null, startingCards?: Array<{ __typename?: 'Entity', id: number, name: string, description: string, cardId: string, cardType: CardType, entityType: EntityType, rarity: Rarity, owner: number, manaCost?: number | null, baseManaCost?: number | null, attack?: number | null, baseAttack?: number | null, hp?: number | null, baseHp?: number | null, maxHp?: number | null, armor?: number | null, playable: boolean, taunt: boolean, charge: boolean, rush: boolean, divineShield: boolean, stealth: boolean, lifesteal: boolean, poisonous: boolean, deathrattles: boolean, battlecry: boolean, windfury: boolean, collectible: boolean, heroClasses: Array<string>, tribes: Array<string>, art?: { __typename?: 'Art', body?: { __typename?: 'ArtFont', vertex?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null } | null, highlight?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, loop?: { __typename?: 'ArtPrefab', named?: string | null } | null, missile?: { __typename?: 'ArtPrefab', named?: string | null } | null, onCast?: { __typename?: 'ArtPrefab', named?: string | null } | null, onHit?: { __typename?: 'ArtPrefab', named?: string | null } | null, primary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, secondary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, shadow?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, spell?: { __typename?: 'ArtPrefab', named?: string | null } | null, sprite?: { __typename?: 'ArtSprite', named?: string | null } | null, spriteShadow?: { __typename?: 'ArtSprite', named?: string | null } | null } | null }> | null, event?: { __typename?: 'GameEvent', eventType: GameEventType, id: number, description: string, isPowerHistory: boolean, isSourcePlayerLocal: boolean, isTargetPlayerLocal: boolean, value?: number | null, entityTouched?: number | null, entityUntouched?: number | null, source?: { __typename?: 'Entity', id: number, name: string, description: string, cardId: string, cardType: CardType, entityType: EntityType, rarity: Rarity, owner: number, manaCost?: number | null, baseManaCost?: number | null, attack?: number | null, baseAttack?: number | null, hp?: number | null, baseHp?: number | null, maxHp?: number | null, armor?: number | null, playable: boolean, taunt: boolean, charge: boolean, rush: boolean, divineShield: boolean, stealth: boolean, lifesteal: boolean, poisonous: boolean, deathrattles: boolean, battlecry: boolean, windfury: boolean, collectible: boolean, heroClasses: Array<string>, tribes: Array<string>, art?: { __typename?: 'Art', body?: { __typename?: 'ArtFont', vertex?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null } | null, highlight?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, loop?: { __typename?: 'ArtPrefab', named?: string | null } | null, missile?: { __typename?: 'ArtPrefab', named?: string | null } | null, onCast?: { __typename?: 'ArtPrefab', named?: string | null } | null, onHit?: { __typename?: 'ArtPrefab', named?: string | null } | null, primary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, secondary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, shadow?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, spell?: { __typename?: 'ArtPrefab', named?: string | null } | null, sprite?: { __typename?: 'ArtSprite', named?: string | null } | null, spriteShadow?: { __typename?: 'ArtSprite', named?: string | null } | null } | null } | null, target?: { __typename?: 'Entity', id: number, name: string, description: string, cardId: string, cardType: CardType, entityType: EntityType, rarity: Rarity, owner: number, manaCost?: number | null, baseManaCost?: number | null, attack?: number | null, baseAttack?: number | null, hp?: number | null, baseHp?: number | null, maxHp?: number | null, armor?: number | null, playable: boolean, taunt: boolean, charge: boolean, rush: boolean, divineShield: boolean, stealth: boolean, lifesteal: boolean, poisonous: boolean, deathrattles: boolean, battlecry: boolean, windfury: boolean, collectible: boolean, heroClasses: Array<string>, tribes: Array<string>, art?: { __typename?: 'Art', body?: { __typename?: 'ArtFont', vertex?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null } | null, highlight?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, loop?: { __typename?: 'ArtPrefab', named?: string | null } | null, missile?: { __typename?: 'ArtPrefab', named?: string | null } | null, onCast?: { __typename?: 'ArtPrefab', named?: string | null } | null, onHit?: { __typename?: 'ArtPrefab', named?: string | null } | null, primary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, secondary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, shadow?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, spell?: { __typename?: 'ArtPrefab', named?: string | null } | null, sprite?: { __typename?: 'ArtSprite', named?: string | null } | null, spriteShadow?: { __typename?: 'ArtSprite', named?: string | null } | null } | null } | null, targets: Array<{ __typename?: 'Entity', id: number, name: string, description: string, cardId: string, cardType: CardType, entityType: EntityType, rarity: Rarity, owner: number, manaCost?: number | null, baseManaCost?: number | null, attack?: number | null, baseAttack?: number | null, hp?: number | null, baseHp?: number | null, maxHp?: number | null, armor?: number | null, playable: boolean, taunt: boolean, charge: boolean, rush: boolean, divineShield: boolean, stealth: boolean, lifesteal: boolean, poisonous: boolean, deathrattles: boolean, battlecry: boolean, windfury: boolean, collectible: boolean, heroClasses: Array<string>, tribes: Array<string>, art?: { __typename?: 'Art', body?: { __typename?: 'ArtFont', vertex?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null } | null, highlight?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, loop?: { __typename?: 'ArtPrefab', named?: string | null } | null, missile?: { __typename?: 'ArtPrefab', named?: string | null } | null, onCast?: { __typename?: 'ArtPrefab', named?: string | null } | null, onHit?: { __typename?: 'ArtPrefab', named?: string | null } | null, primary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, secondary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, shadow?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, spell?: { __typename?: 'ArtPrefab', named?: string | null } | null, sprite?: { __typename?: 'ArtSprite', named?: string | null } | null, spriteShadow?: { __typename?: 'ArtSprite', named?: string | null } | null } | null }>, cardEvent?: { __typename?: 'CardEvent', showLocal: boolean, card?: { __typename?: 'Entity', id: number, name: string, description: string, cardId: string, cardType: CardType, entityType: EntityType, rarity: Rarity, owner: number, manaCost?: number | null, baseManaCost?: number | null, attack?: number | null, baseAttack?: number | null, hp?: number | null, baseHp?: number | null, maxHp?: number | null, armor?: number | null, playable: boolean, taunt: boolean, charge: boolean, rush: boolean, divineShield: boolean, stealth: boolean, lifesteal: boolean, poisonous: boolean, deathrattles: boolean, battlecry: boolean, windfury: boolean, collectible: boolean, heroClasses: Array<string>, tribes: Array<string>, art?: { __typename?: 'Art', body?: { __typename?: 'ArtFont', vertex?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null } | null, highlight?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, loop?: { __typename?: 'ArtPrefab', named?: string | null } | null, missile?: { __typename?: 'ArtPrefab', named?: string | null } | null, onCast?: { __typename?: 'ArtPrefab', named?: string | null } | null, onHit?: { __typename?: 'ArtPrefab', named?: string | null } | null, primary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, secondary?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, shadow?: { __typename?: 'ArtColor', r: number, g: number, b: number, a: number } | null, spell?: { __typename?: 'ArtPrefab', named?: string | null } | null, sprite?: { __typename?: 'ArtSprite', named?: string | null } | null, spriteShadow?: { __typename?: 'ArtSprite', named?: string | null } | null } | null } | null } | null, performedGameAction?: { __typename?: 'PerformedGameActionEvent', actionType: ActionType } | null } | null, gameOver?: { __typename?: 'GameOver', localPlayerWon: boolean, winningPlayerId?: number | null } | null, emote?: { __typename?: 'Emote', entityId: number, message: EmoteType } | null, timers?: { __typename?: 'Timers', millisRemaining: any } | null };
...
export type AddFriendMutation = { __typename?: 'Mutation', addFriend: { __typename?: 'Friend', friendId: string, friendName: string, presence: Presence, since: any } };
...
export type DeleteEditableCardMutationVariables = Exact<{
  editableCardId: Scalars['String'];
}>;


export type DeleteEditableCardMutation = { __typename?: 'Mutation', deleteCard: boolean };
...
export type PutCardMutationVariables = Exact<{
  input: PutCardInput;
}>;


export type PutCardMutation = { __typename?: 'Mutation', putCard: { __typename?: 'PutCardResult', cardId: string, editableCardId: string, cardScriptErrors: Array<string> } };
...
export const EntityLocationFragmentDoc = gql`
 ...
 *      usernameWithToken: // value for 'usernameWithToken'
 *   },
 * });
 */
...
export const DeleteEditableCardDocument = gql`
    mutation deleteEditableCard($editableCardId: String!) {
  deleteCard(editableCardId: $editableCardId)
}
    `;
export type DeleteEditableCardMutationFn = Apollo.MutationFunction<DeleteEditableCardMutation, DeleteEditableCardMutationVariables>;

/**
 * __useDeleteEditableCardMutation__
 *
 * To run a mutation, you first call `useDeleteEditableCardMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useDeleteEditableCardMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [deleteEditableCardMutation, { data, loading, error }] = useDeleteEditableCardMutation({
 *   variables: {
 *      editableCardId: // value for 'editableCardId'
 *   },
 * });
 */
export function useDeleteEditableCardMutation(baseOptions?: Apollo.MutationHookOptions<DeleteEditableCardMutation, DeleteEditableCardMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<DeleteEditableCardMutation, DeleteEditableCardMutationVariables>(DeleteEditableCardDocument, options);
      }
export type DeleteEditableCardMutationHookResult = ReturnType<typeof useDeleteEditableCardMutation>;
export type DeleteEditableCardMutationResult = Apollo.MutationResult<DeleteEditableCardMutation>;
export type DeleteEditableCardMutationOptions = Apollo.BaseMutationOptions<DeleteEditableCardMutation, DeleteEditableCardMutationVariables>;
...
export const PutCardDocument = gql`
  ...
  putCard(input: $input) {
    ...
    `;
export type PutCardMutationFn = Apollo.MutationFunction<PutCardMutation, PutCardMutationVariables>;

/**
 * __usePutCardMutation__
 *
 * To run a mutation, you first call `usePutCardMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `usePutCardMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [putCardMutation, { data, loading, error }] = usePutCardMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function usePutCardMutation(baseOptions?: Apollo.MutationHookOptions<PutCardMutation, PutCardMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<PutCardMutation, PutCardMutationVariables>(PutCardDocument, options);
      }
export type PutCardMutationHookResult = ReturnType<typeof usePutCardMutation>;
export type PutCardMutationResult = Apollo.MutationResult<PutCardMutation>;
export type PutCardMutationOptions = Apollo.BaseMutationOptions<PutCardMutation, PutCardMutationVariables>;
