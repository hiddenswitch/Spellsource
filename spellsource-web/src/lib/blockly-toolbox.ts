...
export function editorToolbox(results: string[] = [], data: ContextType<typeof BlocklyDataContext>): any {
  return {
    ...
    contents: [
      ...
      category('Card Starters', '#888888',
        "The core blocks that cards of any type will be built from",
        contents('Starter')
      ),

      category('Card Properties', '#888888',
        "Blocks to add additional properties to your card (placed connected to your Starter)",
        contents('Property')
      ),

      category('Card Art', '#888888',
        "Blocks representing the art that your card can have",
        [
          category('Unused', '#888888', "Art that hasn't yet been used by a card",
            artContents(false)
          ),
          category('Used', '#888888', "Art that's been used by cards already",
            artContents(true)
          ),
          category('All', '#888888', "All available art",
            artContents(null)
          )
        ]
      ),
      ...
      category('Targets', '30',
        ...
        [
          category('Ally', '30',
            ...
            subContents('EntityReference', 'Ally')
          ),

          category('Enemy', '30',
            'Blocks that target enemy things',
            subContents('EntityReference', 'Enemy')
          ),
          ...
          category('Misc', '30',
            ...
            subContents('EntityReference', 'Misc')
          ),
      ...
      category('Players', '45',
        ...
        [
          ...exclusionContents('TargetPlayer', 'TargetPlayer_1',
            'TargetPlayer_2'),
          {
            "kind": "label",
            "text": " "
      ...
      category('Triggers', '300',
        ...
        [
          ...
          category('Turn', '300',
            ...
            subContents('Trigger', 'Turn')
          ),

          category('Misc', '300',
            "Trigger blocks that aren't otherwise categorized",
            subContents('Trigger', 'Misc')
          ),
      ...
      category('Custom', '-1',
        ...
        [
          category('Custom Blocks', '#000000',
            "",
            subContents("Custom", "Desc")
          ),

          category('Custom Args', '#000000',
            "",
            subContents("Custom", "Arg")
          ),

          category('Custom Enums', '#000000',
            "",
            subContents("Custom", "Enum")
          )
        ]
      ),

      category('Simulation', -1,
        "Blocks for creating simulation tests to see if your cards work",
        [
          category('Testing', '#888888',
            "The blocks used to start a new test",
            inclusionContents('TestStarter',
              'TestAssertion')
          ),

          category('Actions', '260',
            "Blocks for actions that you can simulate players taking",
            contents('TestAction')
          ),

          category('Variables', '310',
      ...
      if (!!json['args' + i.toString()]) {
        for (let j = 0; j < 10; j++) {
          ...
          if (!!arg && !!arg.shadow) {
            ...
            shadowContents.push(...blockContents(arg.shadow.type))
