/* eslint-disable */
import { type CallOptions, ChannelCredentials, Client, ClientDuplexStream, type ClientOptions, ClientReadableStream, type ClientUnaryCall, handleBidiStreamingCall, handleServerStreamingCall, type handleUnaryCall, makeGenericClientConstructor, Metadata, type ServiceError, type UntypedServiceImplementation } from "@grpc/grpc-js";
...
export const MatchmakingService = {
  enqueue: {
    path: "/spellsource.Matchmaking/Enqueue",
    requestStream: true,
    responseStream: true,
    requestSerialize: (value: MatchmakingQueuePutRequest) => Buffer.from(MatchmakingQueuePutRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => MatchmakingQueuePutRequest.decode(value),
    responseSerialize: (value: MatchmakingQueuePutResponse) => Buffer.from(MatchmakingQueuePutResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => MatchmakingQueuePutResponse.decode(value),
  },
  /** Removes your client from the matchmaking queue, regardless of which queue it is in. */
  matchmakingDelete: {
    path: "/spellsource.Matchmaking/MatchmakingDelete",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: Empty) => Buffer.from(Empty.encode(value).finish()),
    requestDeserialize: (value: Buffer) => Empty.decode(value),
    responseSerialize: (value: MatchCancelResponse) => Buffer.from(MatchCancelResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => MatchCancelResponse.decode(value),
  },
  /** Gets a list of queues available for matchmaking. */
  matchmakingGet: {
    path: "/spellsource.Matchmaking/MatchmakingGet",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: Empty) => Buffer.from(Empty.encode(value).finish()),
    requestDeserialize: (value: Buffer) => Empty.decode(value),
    responseSerialize: (value: MatchmakingQueuesResponse) => Buffer.from(MatchmakingQueuesResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => MatchmakingQueuesResponse.decode(value),
  },
} as const;

export interface MatchmakingServer extends UntypedServiceImplementation {
  enqueue: handleBidiStreamingCall<MatchmakingQueuePutRequest, MatchmakingQueuePutResponse>;
  /** Removes your client from the matchmaking queue, regardless of which queue it is in. */
  matchmakingDelete: handleUnaryCall<Empty, MatchCancelResponse>;
  /** Gets a list of queues available for matchmaking. */
  matchmakingGet: handleUnaryCall<Empty, MatchmakingQueuesResponse>;
}

export interface MatchmakingClient extends Client {
  enqueue(): ClientDuplexStream<MatchmakingQueuePutRequest, MatchmakingQueuePutResponse>;
  enqueue(options: Partial<CallOptions>): ClientDuplexStream<MatchmakingQueuePutRequest, MatchmakingQueuePutResponse>;
  enqueue(metadata: Metadata, options?: Partial<CallOptions>): ClientDuplexStream<MatchmakingQueuePutRequest, MatchmakingQueuePutResponse>;
  /** Removes your client from the matchmaking queue, regardless of which queue it is in. */
  matchmakingDelete(request: Empty, callback: (error: ServiceError | null, response: MatchCancelResponse) => void): ClientUnaryCall;
  matchmakingDelete(request: Empty, metadata: Metadata, callback: (error: ServiceError | null, response: MatchCancelResponse) => void): ClientUnaryCall;
  matchmakingDelete(request: Empty, metadata: Metadata, options: Partial<CallOptions>, callback: (error: ServiceError | null, response: MatchCancelResponse) => void): ClientUnaryCall;
  /** Gets a list of queues available for matchmaking. */
  matchmakingGet(request: Empty, callback: (error: ServiceError | null, response: MatchmakingQueuesResponse) => void): ClientUnaryCall;
  matchmakingGet(request: Empty, metadata: Metadata, callback: (error: ServiceError | null, response: MatchmakingQueuesResponse) => void): ClientUnaryCall;
  matchmakingGet(request: Empty, metadata: Metadata, options: Partial<CallOptions>, callback: (error: ServiceError | null, response: MatchmakingQueuesResponse) => void): ClientUnaryCall;
}

export const MatchmakingClient = makeGenericClientConstructor(MatchmakingService, "spellsource.Matchmaking") as unknown as {
...
export type HiddenSwitchSpellsourceAPIServiceService = typeof HiddenSwitchSpellsourceAPIServiceService;
export const HiddenSwitchSpellsourceAPIServiceService = {
  putCard: {
    path: "/spellsource.HiddenSwitchSpellsourceAPIService/PutCard",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: Envelope_MethodMessage_PutCardMessage) => Buffer.from(Envelope_MethodMessage_PutCardMessage.encode(value).finish()),
    requestDeserialize: (value: Buffer) => Envelope_MethodMessage_PutCardMessage.decode(value),
    responseSerialize: (value: Envelope_ResultMessage_PutCardMessage) => Buffer.from(Envelope_ResultMessage_PutCardMessage.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Envelope_ResultMessage_PutCardMessage.decode(value),
  },
  sendMessage: {
    path: "/spellsource.HiddenSwitchSpellsourceAPIService/SendMessage",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: Envelope_MethodMessage_SendMessageMessage) => Buffer.from(Envelope_MethodMessage_SendMessageMessage.encode(value).finish()),
    requestDeserialize: (value: Buffer) => Envelope_MethodMessage_SendMessageMessage.decode(value),
    responseSerialize: (value: Envelope_ResultMessage_SendMessageMessage) => Buffer.from(Envelope_ResultMessage_SendMessageMessage.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Envelope_ResultMessage_SendMessageMessage.decode(value),
  },
  deleteCard: {
    path: "/spellsource.HiddenSwitchSpellsourceAPIService/DeleteCard",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: Envelope_MethodMessage_DeleteCardMessage) => Buffer.from(Envelope_MethodMessage_DeleteCardMessage.encode(value).finish()),
    requestDeserialize: (value: Buffer) => Envelope_MethodMessage_DeleteCardMessage.decode(value),
    responseSerialize: (value: Envelope_RemovedMessage) => Buffer.from(Envelope_RemovedMessage.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Envelope_RemovedMessage.decode(value),
  },
  subscribeFriends: {
    path: "/spellsource.HiddenSwitchSpellsourceAPIService/SubscribeFriends",
    requestStream: false,
    responseStream: true,
    requestSerialize: (value: Empty) => Buffer.from(Empty.encode(value).finish()),
    requestDeserialize: (value: Buffer) => Empty.decode(value),
    responseSerialize: (value: Friend) => Buffer.from(Friend.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Friend.decode(value),
  },
  subscribeInvites: {
    path: "/spellsource.HiddenSwitchSpellsourceAPIService/SubscribeInvites",
    requestStream: false,
    responseStream: true,
    requestSerialize: (value: Empty) => Buffer.from(Empty.encode(value).finish()),
    requestDeserialize: (value: Buffer) => Empty.decode(value),
    responseSerialize: (value: Invite) => Buffer.from(Invite.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Invite.decode(value),
  },
  subscribeEditableCards: {
    path: "/spellsource.HiddenSwitchSpellsourceAPIService/SubscribeEditableCards",
    requestStream: false,
    responseStream: true,
    requestSerialize: (value: Empty) => Buffer.from(Empty.encode(value).finish()),
    requestDeserialize: (value: Buffer) => Empty.decode(value),
    responseSerialize: (value: EditableCard) => Buffer.from(EditableCard.encode(value).finish()),
    responseDeserialize: (value: Buffer) => EditableCard.decode(value),
  },
  subscribeMatch: {
    path: "/spellsource.HiddenSwitchSpellsourceAPIService/SubscribeMatch",
    requestStream: false,
    responseStream: true,
    requestSerialize: (value: Empty) => Buffer.from(Empty.encode(value).finish()),
    requestDeserialize: (value: Buffer) => Empty.decode(value),
    responseSerialize: (value: Match) => Buffer.from(Match.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Match.decode(value),
  },
  subscribeGame: {
    path: "/spellsource.HiddenSwitchSpellsourceAPIService/SubscribeGame",
    requestStream: true,
    responseStream: true,
    requestSerialize: (value: ClientToServerMessage) => Buffer.from(ClientToServerMessage.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ClientToServerMessage.decode(value),
   ...
   */
  acceptInvite: {
    path: "/spellsource.HiddenSwitchSpellsourceAPIService/AcceptInvite",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: AcceptInviteRequest) => Buffer.from(AcceptInviteRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => AcceptInviteRequest.decode(value),
    responseSerialize: (value: AcceptInviteResponse) => Buffer.from(AcceptInviteResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => AcceptInviteResponse.decode(value),
  },
  /** Changes your password. Does not log you out after the password is changed. */
  changePassword: {
    path: "/spellsource.HiddenSwitchSpellsourceAPIService/ChangePassword",
    requestStream: false,
    responseStream: false,
  ...
  createAccount: {
    path: "/spellsource.HiddenSwitchSpellsourceAPIService/CreateAccount",
    requestStream: false,
    responseStream: false,
    ...
    responseSerialize: (value: CreateAccountResponse) => Buffer.from(CreateAccountResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => CreateAccountResponse.decode(value),
  },
  /** Deletes the specified deck by ID. */
  decksDelete: {
    path: "/spellsource.HiddenSwitchSpellsourceAPIService/DecksDelete",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: DecksDeleteRequest) => Buffer.from(DecksDeleteRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => DecksDeleteRequest.decode(value),
    responseSerialize: (value: Empty) => Buffer.from(Empty.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Empty.decode(value),
  },
  /** Gets a deck. Only viewable for the owner of the deck or players in the alliance. */
  decksGet: {
    path: "/spellsource.HiddenSwitchSpellsourceAPIService/DecksGet",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: DecksGetRequest) => Buffer.from(DecksGetRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => DecksGetRequest.decode(value),
    responseSerialize: (value: DecksGetResponse) => Buffer.from(DecksGetResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => DecksGetResponse.decode(value),
  },
  /** Gets all the user's decks. */
  decksGetAll: {
    path: "/spellsource.HiddenSwitchSpellsourceAPIService/DecksGetAll",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: Empty) => Buffer.from(Empty.encode(value).finish()),
    requestDeserialize: (value: Buffer) => Empty.decode(value),
    responseSerialize: (value: DecksGetAllResponse) => Buffer.from(DecksGetAllResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => DecksGetAllResponse.decode(value),
  },
  /** Creates a new deck with optionally specified inventory IDs, a name and a hero class. */
  decksPut: {
    path: "/spellsource.HiddenSwitchSpellsourceAPIService/DecksPut",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: DecksPutRequest) => Buffer.from(DecksPutRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => DecksPutRequest.decode(value),
    responseSerialize: (value: DecksPutResponse) => Buffer.from(DecksPutResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => DecksPutResponse.decode(value),
  },
  /**
   ...
   */
  decksUpdate: {
    path: "/spellsource.HiddenSwitchSpellsourceAPIService/DecksUpdate",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: DecksUpdateRequest) => Buffer.from(DecksUpdateRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => DecksUpdateRequest.decode(value),
    responseSerialize: (value: DecksGetResponse) => Buffer.from(DecksGetResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => DecksGetResponse.decode(value),
  },
  /** Duplicates a deck. Creates a copy for the caller, not the owner */
  duplicateDeck: {
    path: "/spellsource.HiddenSwitchSpellsourceAPIService/DuplicateDeck",
    requestStream: false,
    responseStream: false,
  ...
  deleteInvite: {
    path: "/spellsource.HiddenSwitchSpellsourceAPIService/DeleteInvite",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: DeleteInviteRequest) => Buffer.from(DeleteInviteRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => DeleteInviteRequest.decode(value),
    responseSerialize: (value: InviteResponse) => Buffer.from(InviteResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => InviteResponse.decode(value),
  },
  /** Make a selection for the given draft index. */
  draftsChooseCard: {
    path: "/spellsource.HiddenSwitchSpellsourceAPIService/DraftsChooseCard",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: DraftsChooseCardRequest) => Buffer.from(DraftsChooseCardRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => DraftsChooseCardRequest.decode(value),
    responseSerialize: (value: DraftState) => Buffer.from(DraftState.encode(value).finish()),
    responseDeserialize: (value: Buffer) => DraftState.decode(value),
  },
  /** Choose a hero from your hero selection. */
  draftsChooseHero: {
    path: "/spellsource.HiddenSwitchSpellsourceAPIService/DraftsChooseHero",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: DraftsChooseHeroRequest) => Buffer.from(DraftsChooseHeroRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => DraftsChooseHeroRequest.decode(value),
    responseSerialize: (value: DraftState) => Buffer.from(DraftState.encode(value).finish()),
    responseDeserialize: (value: Buffer) => DraftState.decode(value),
  },
  /** Gets your latest state of the draft. */
  draftsGet: {
    path: "/spellsource.HiddenSwitchSpellsourceAPIService/DraftsGet",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: Empty) => Buffer.from(Empty.encode(value).finish()),
    requestDeserialize: (value: Buffer) => Empty.decode(value),
  ...
  draftsPost: {
    path: "/spellsource.HiddenSwitchSpellsourceAPIService/DraftsPost",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: DraftsPostRequest) => Buffer.from(DraftsPostRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => DraftsPostRequest.decode(value),
    responseSerialize: (value: DraftState) => Buffer.from(DraftState.encode(value).finish()),
    responseDeserialize: (value: Buffer) => DraftState.decode(value),
  },
  /** Removes the friend relationship between two users. */
  friendDelete: {
    path: "/spellsource.HiddenSwitchSpellsourceAPIService/FriendDelete",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: FriendDeleteRequest) => Buffer.from(FriendDeleteRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => FriendDeleteRequest.decode(value),
    responseSerialize: (value: UnfriendResponse) => Buffer.from(UnfriendResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => UnfriendResponse.decode(value),
  },
  /** Adds a specified user to your friend list. */
  friendPut: {
    path: "/spellsource.HiddenSwitchSpellsourceAPIService/FriendPut",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: FriendPutRequest) => Buffer.from(FriendPutRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => FriendPutRequest.decode(value),
    responseSerialize: (value: FriendPutResponse) => Buffer.from(FriendPutResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => FriendPutResponse.decode(value),
  },
  /** Get a specific account. Contains more information if the userId matches the requesting user. */
  getAccount: {
    path: "/spellsource.HiddenSwitchSpellsourceAPIService/GetAccount",
    requestStream: false,
    responseStream: false,
  ...
  getAccounts: {
    path: "/spellsource.HiddenSwitchSpellsourceAPIService/GetAccounts",
    requestStream: false,
    responseStream: false,
   ...
   */
  getGameRecord: {
    path: "/spellsource.HiddenSwitchSpellsourceAPIService/GetGameRecord",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetGameRecordRequest) => Buffer.from(GetGameRecordRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetGameRecordRequest.decode(value),
    responseSerialize: (value: GetGameRecordResponse) => Buffer.from(GetGameRecordResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => GetGameRecordResponse.decode(value),
  },
  /** Retrieves a list of game IDs corresponding to all the games this player played. */
  getGameRecordIds: {
    path: "/spellsource.HiddenSwitchSpellsourceAPIService/GetGameRecordIds",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: Empty) => Buffer.from(Empty.encode(value).finish()),
    requestDeserialize: (value: Buffer) => Empty.decode(value),
    responseSerialize: (value: GetGameRecordIdsResponse) => Buffer.from(GetGameRecordIdsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => GetGameRecordIdsResponse.decode(value),
  },
  /** Retrieves information about a specific invite, as long as this user is either the sender or recipient. */
  getInvite: {
    path: "/spellsource.HiddenSwitchSpellsourceAPIService/GetInvite",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetInviteRequest) => Buffer.from(GetInviteRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetInviteRequest.decode(value),
    responseSerialize: (value: InviteResponse) => Buffer.from(InviteResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => InviteResponse.decode(value),
  },
  /** Retrieve all invites where this user is either the sender or recipient. */
  getInvites: {
    path: "/spellsource.HiddenSwitchSpellsourceAPIService/GetInvites",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: Empty) => Buffer.from(Empty.encode(value).finish()),
    requestDeserialize: (value: Buffer) => Empty.decode(value),
    responseSerialize: (value: InviteGetResponse) => Buffer.from(InviteGetResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => InviteGetResponse.decode(value),
  },
  /** Login with a username and password, receiving an authentication token to use for future sessions. */
  login: {
    path: "/spellsource.HiddenSwitchSpellsourceAPIService/Login",
    requestStream: false,
    responseStream: false,
  ...
  /** Send an invite. */
  postInvite: {
    path: "/spellsource.HiddenSwitchSpellsourceAPIService/PostInvite",
    requestStream: false,
    responseStream: true,
    requestSerialize: (value: PostInviteRequest) => Buffer.from(PostInviteRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => PostInviteRequest.decode(value),
    responseSerialize: (value: InviteResponse) => Buffer.from(InviteResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => InviteResponse.decode(value),
  },
  /** Provided a valid reset token, resets a user's password. */
  postPasswordReset: {
    path: "/spellsource.HiddenSwitchSpellsourceAPIService/PostPasswordReset",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: PostPasswordResetRequest) => Buffer.from(PostPasswordResetRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => PostPasswordResetRequest.decode(value),
    responseSerialize: (value: Empty) => Buffer.from(Empty.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Empty.decode(value),
  },
} as const;

export interface HiddenSwitchSpellsourceAPIServiceServer extends UntypedServiceImplementation {
  putCard: handleUnaryCall<Envelope_MethodMessage_PutCardMessage, Envelope_ResultMessage_PutCardMessage>;
  sendMessage: handleUnaryCall<Envelope_MethodMessage_SendMessageMessage, Envelope_ResultMessage_SendMessageMessage>;
  deleteCard: handleUnaryCall<Envelope_MethodMessage_DeleteCardMessage, Envelope_RemovedMessage>;
  subscribeFriends: handleServerStreamingCall<Empty, Friend>;
  subscribeInvites: handleServerStreamingCall<Empty, Invite>;
  subscribeEditableCards: handleServerStreamingCall<Empty, EditableCard>;
  subscribeMatch: handleServerStreamingCall<Empty, Match>;
  subscribeGame: handleBidiStreamingCall<ClientToServerMessage, ServerToClientMessage>;
  /**
   * Accepts the invite. If this is an invite to friend the user, this method will perform the friending path for
   * you. If this is an invite to play a match and a matchmaking queue put is specified (with the deck ID), this
   * method will enter you into the special invite matchmaking queue.
   */
  acceptInvite: handleUnaryCall<AcceptInviteRequest, AcceptInviteResponse>;
  /** Changes your password. Does not log you out after the password is changed. */
  ...
  /** Deletes the specified deck by ID. */
  decksDelete: handleUnaryCall<DecksDeleteRequest, Empty>;
  /** Gets a deck. Only viewable for the owner of the deck or players in the alliance. */
  decksGet: handleUnaryCall<DecksGetRequest, DecksGetResponse>;
  /** Gets all the user's decks. */
  decksGetAll: handleUnaryCall<Empty, DecksGetAllResponse>;
  /** Creates a new deck with optionally specified inventory IDs, a name and a hero class. */
  decksPut: handleUnaryCall<DecksPutRequest, DecksPutResponse>;
  /**
   * Updates the deck by adding or removing cards, changing the hero class, or renaming the deck.
   *
   * Also gives players the ability to set special gameplay attributes (like the Signature) for the deck.
   */
  decksUpdate: handleUnaryCall<DecksUpdateRequest, DecksGetResponse>;
  /** Duplicates a deck. Creates a copy for the caller, not the owner */
  duplicateDeck: handleUnaryCall<string | undefined, DecksGetResponse>;
  /** When this user is the sender, cancels the invite. When this user is the recipient, rejects the specified invite. */
  deleteInvite: handleUnaryCall<DeleteInviteRequest, InviteResponse>;
  /** Make a selection for the given draft index. */
  draftsChooseCard: handleUnaryCall<DraftsChooseCardRequest, DraftState>;
  /** Choose a hero from your hero selection. */
  draftsChooseHero: handleUnaryCall<DraftsChooseHeroRequest, DraftState>;
  /** Gets your latest state of the draft. */
  draftsGet: handleUnaryCall<Empty, DraftState>;
  /** Starts a draft, or make a change to your draft, like retiring early. */
  draftsPost: handleUnaryCall<DraftsPostRequest, DraftState>;
  /** Removes the friend relationship between two users. */
  friendDelete: handleUnaryCall<FriendDeleteRequest, UnfriendResponse>;
  /** Adds a specified user to your friend list. */
  friendPut: handleUnaryCall<FriendPutRequest, FriendPutResponse>;
  /** Get a specific account. Contains more information if the userId matches the requesting user. */
  getAccount: handleUnaryCall<GetAccountRequest, GetAccountsResponse>;
  /** Get a list of accounts including user profile information. */
   ...
   * against other players only receive this player's point of view.
   */
  getGameRecord: handleUnaryCall<GetGameRecordRequest, GetGameRecordResponse>;
  /** Retrieves a list of game IDs corresponding to all the games this player played. */
  getGameRecordIds: handleUnaryCall<Empty, GetGameRecordIdsResponse>;
  /** Retrieves information about a specific invite, as long as this user is either the sender or recipient. */
  getInvite: handleUnaryCall<GetInviteRequest, InviteResponse>;
  /** Retrieve all invites where this user is either the sender or recipient. */
  getInvites: handleUnaryCall<Empty, InviteGetResponse>;
  /** Login with a username and password, receiving an authentication token to use for future sessions. */
  login: handleUnaryCall<LoginRequest, LoginResponse>;
  /** Send an invite. */
  postInvite: handleServerStreamingCall<PostInviteRequest, InviteResponse>;
  /** Provided a valid reset token, resets a user's password. */
  postPasswordReset: handleUnaryCall<PostPasswordResetRequest, Empty>;
}

export interface HiddenSwitchSpellsourceAPIServiceClient extends Client {
  putCard(request: Envelope_MethodMessage_PutCardMessage, callback: (error: ServiceError | null, response: Envelope_ResultMessage_PutCardMessage) => void): ClientUnaryCall;
  putCard(request: Envelope_MethodMessage_PutCardMessage, metadata: Metadata, callback: (error: ServiceError | null, response: Envelope_ResultMessage_PutCardMessage) => void): ClientUnaryCall;
  putCard(request: Envelope_MethodMessage_PutCardMessage, metadata: Metadata, options: Partial<CallOptions>, callback: (error: ServiceError | null, response: Envelope_ResultMessage_PutCardMessage) => void): ClientUnaryCall;
  sendMessage(request: Envelope_MethodMessage_SendMessageMessage, callback: (error: ServiceError | null, response: Envelope_ResultMessage_SendMessageMessage) => void): ClientUnaryCall;
  sendMessage(request: Envelope_MethodMessage_SendMessageMessage, metadata: Metadata, callback: (error: ServiceError | null, response: Envelope_ResultMessage_SendMessageMessage) => void): ClientUnaryCall;
  sendMessage(request: Envelope_MethodMessage_SendMessageMessage, metadata: Metadata, options: Partial<CallOptions>, callback: (error: ServiceError | null, response: Envelope_ResultMessage_SendMessageMessage) => void): ClientUnaryCall;
  deleteCard(request: Envelope_MethodMessage_DeleteCardMessage, callback: (error: ServiceError | null, response: Envelope_RemovedMessage) => void): ClientUnaryCall;
  deleteCard(request: Envelope_MethodMessage_DeleteCardMessage, metadata: Metadata, callback: (error: ServiceError | null, response: Envelope_RemovedMessage) => void): ClientUnaryCall;
  deleteCard(request: Envelope_MethodMessage_DeleteCardMessage, metadata: Metadata, options: Partial<CallOptions>, callback: (error: ServiceError | null, response: Envelope_RemovedMessage) => void): ClientUnaryCall;
  subscribeFriends(request: Empty, options?: Partial<CallOptions>): ClientReadableStream<Friend>;
  subscribeFriends(request: Empty, metadata?: Metadata, options?: Partial<CallOptions>): ClientReadableStream<Friend>;
  subscribeInvites(request: Empty, options?: Partial<CallOptions>): ClientReadableStream<Invite>;
  subscribeInvites(request: Empty, metadata?: Metadata, options?: Partial<CallOptions>): ClientReadableStream<Invite>;
  subscribeEditableCards(request: Empty, options?: Partial<CallOptions>): ClientReadableStream<EditableCard>;
  subscribeEditableCards(request: Empty, metadata?: Metadata, options?: Partial<CallOptions>): ClientReadableStream<EditableCard>;
  subscribeMatch(request: Empty, options?: Partial<CallOptions>): ClientReadableStream<Match>;
  subscribeMatch(request: Empty, metadata?: Metadata, options?: Partial<CallOptions>): ClientReadableStream<Match>;
  subscribeGame(): ClientDuplexStream<ClientToServerMessage, ServerToClientMessage>;
  subscribeGame(options: Partial<CallOptions>): ClientDuplexStream<ClientToServerMessage, ServerToClientMessage>;
  subscribeGame(metadata: Metadata, options?: Partial<CallOptions>): ClientDuplexStream<ClientToServerMessage, ServerToClientMessage>;
  /**
   * Accepts the invite. If this is an invite to friend the user, this method will perform the friending path for
   * you. If this is an invite to play a match and a matchmaking queue put is specified (with the deck ID), this
   * method will enter you into the special invite matchmaking queue.
   */
  acceptInvite(request: AcceptInviteRequest, callback: (error: ServiceError | null, response: AcceptInviteResponse) => void): ClientUnaryCall;
  acceptInvite(request: AcceptInviteRequest, metadata: Metadata, callback: (error: ServiceError | null, response: AcceptInviteResponse) => void): ClientUnaryCall;
  acceptInvite(request: AcceptInviteRequest, metadata: Metadata, options: Partial<CallOptions>, callback: (error: ServiceError | null, response: AcceptInviteResponse) => void): ClientUnaryCall;
  /** Changes your password. Does not log you out after the password is changed. */
  changePassword(request: ChangePasswordRequest, callback: (error: ServiceError | null, response: ChangePasswordResponse) => void): ClientUnaryCall;
  changePassword(request: ChangePasswordRequest, metadata: Metadata, callback: (error: ServiceError | null, response: ChangePasswordResponse) => void): ClientUnaryCall;
  changePassword(request: ChangePasswordRequest, metadata: Metadata, options: Partial<CallOptions>, callback: (error: ServiceError | null, response: ChangePasswordResponse) => void): ClientUnaryCall;
  /** Create an account with Spellsource. */
  createAccount(request: CreateAccountRequest, callback: (error: ServiceError | null, response: CreateAccountResponse) => void): ClientUnaryCall;
  createAccount(request: CreateAccountRequest, metadata: Metadata, callback: (error: ServiceError | null, response: CreateAccountResponse) => void): ClientUnaryCall;
  createAccount(request: CreateAccountRequest, metadata: Metadata, options: Partial<CallOptions>, callback: (error: ServiceError | null, response: CreateAccountResponse) => void): ClientUnaryCall;
  /** Deletes the specified deck by ID. */
  decksDelete(request: DecksDeleteRequest, callback: (error: ServiceError | null, response: Empty) => void): ClientUnaryCall;
  decksDelete(request: DecksDeleteRequest, metadata: Metadata, callback: (error: ServiceError | null, response: Empty) => void): ClientUnaryCall;
  decksDelete(request: DecksDeleteRequest, metadata: Metadata, options: Partial<CallOptions>, callback: (error: ServiceError | null, response: Empty) => void): ClientUnaryCall;
  /** Gets a deck. Only viewable for the owner of the deck or players in the alliance. */
  decksGet(request: DecksGetRequest, callback: (error: ServiceError | null, response: DecksGetResponse) => void): ClientUnaryCall;
  decksGet(request: DecksGetRequest, metadata: Metadata, callback: (error: ServiceError | null, response: DecksGetResponse) => void): ClientUnaryCall;
  decksGet(request: DecksGetRequest, metadata: Metadata, options: Partial<CallOptions>, callback: (error: ServiceError | null, response: DecksGetResponse) => void): ClientUnaryCall;
  /** Gets all the user's decks. */
  decksGetAll(request: Empty, callback: (error: ServiceError | null, response: DecksGetAllResponse) => void): ClientUnaryCall;
  decksGetAll(request: Empty, metadata: Metadata, callback: (error: ServiceError | null, response: DecksGetAllResponse) => void): ClientUnaryCall;
  decksGetAll(request: Empty, metadata: Metadata, options: Partial<CallOptions>, callback: (error: ServiceError | null, response: DecksGetAllResponse) => void): ClientUnaryCall;
  /** Creates a new deck with optionally specified inventory IDs, a name and a hero class. */
  decksPut(request: DecksPutRequest, callback: (error: ServiceError | null, response: DecksPutResponse) => void): ClientUnaryCall;
  decksPut(request: DecksPutRequest, metadata: Metadata, callback: (error: ServiceError | null, response: DecksPutResponse) => void): ClientUnaryCall;
  decksPut(request: DecksPutRequest, metadata: Metadata, options: Partial<CallOptions>, callback: (error: ServiceError | null, response: DecksPutResponse) => void): ClientUnaryCall;
  /**
   * Updates the deck by adding or removing cards, changing the hero class, or renaming the deck.
   *
   * Also gives players the ability to set special gameplay attributes (like the Signature) for the deck.
   */
  decksUpdate(request: DecksUpdateRequest, callback: (error: ServiceError | null, response: DecksGetResponse) => void): ClientUnaryCall;
  decksUpdate(request: DecksUpdateRequest, metadata: Metadata, callback: (error: ServiceError | null, response: DecksGetResponse) => void): ClientUnaryCall;
  decksUpdate(request: DecksUpdateRequest, metadata: Metadata, options: Partial<CallOptions>, callback: (error: ServiceError | null, response: DecksGetResponse) => void): ClientUnaryCall;
  /** Duplicates a deck. Creates a copy for the caller, not the owner */
  duplicateDeck(request: string | undefined, callback: (error: ServiceError | null, response: DecksGetResponse) => void): ClientUnaryCall;
  duplicateDeck(request: string | undefined, metadata: Metadata, callback: (error: ServiceError | null, response: DecksGetResponse) => void): ClientUnaryCall;
  duplicateDeck(request: string | undefined, metadata: Metadata, options: Partial<CallOptions>, callback: (error: ServiceError | null, response: DecksGetResponse) => void): ClientUnaryCall;
  /** When this user is the sender, cancels the invite. When this user is the recipient, rejects the specified invite. */
  deleteInvite(request: DeleteInviteRequest, callback: (error: ServiceError | null, response: InviteResponse) => void): ClientUnaryCall;
  deleteInvite(request: DeleteInviteRequest, metadata: Metadata, callback: (error: ServiceError | null, response: InviteResponse) => void): ClientUnaryCall;
  deleteInvite(request: DeleteInviteRequest, metadata: Metadata, options: Partial<CallOptions>, callback: (error: ServiceError | null, response: InviteResponse) => void): ClientUnaryCall;
  /** Make a selection for the given draft index. */
  draftsChooseCard(request: DraftsChooseCardRequest, callback: (error: ServiceError | null, response: DraftState) => void): ClientUnaryCall;
  draftsChooseCard(request: DraftsChooseCardRequest, metadata: Metadata, callback: (error: ServiceError | null, response: DraftState) => void): ClientUnaryCall;
  draftsChooseCard(request: DraftsChooseCardRequest, metadata: Metadata, options: Partial<CallOptions>, callback: (error: ServiceError | null, response: DraftState) => void): ClientUnaryCall;
  /** Choose a hero from your hero selection. */
  draftsChooseHero(request: DraftsChooseHeroRequest, callback: (error: ServiceError | null, response: DraftState) => void): ClientUnaryCall;
  draftsChooseHero(request: DraftsChooseHeroRequest, metadata: Metadata, callback: (error: ServiceError | null, response: DraftState) => void): ClientUnaryCall;
  draftsChooseHero(request: DraftsChooseHeroRequest, metadata: Metadata, options: Partial<CallOptions>, callback: (error: ServiceError | null, response: DraftState) => void): ClientUnaryCall;
  /** Gets your latest state of the draft. */
  draftsGet(request: Empty, callback: (error: ServiceError | null, response: DraftState) => void): ClientUnaryCall;
  draftsGet(request: Empty, metadata: Metadata, callback: (error: ServiceError | null, response: DraftState) => void): ClientUnaryCall;
  draftsGet(request: Empty, metadata: Metadata, options: Partial<CallOptions>, callback: (error: ServiceError | null, response: DraftState) => void): ClientUnaryCall;
  /** Starts a draft, or make a change to your draft, like retiring early. */
  draftsPost(request: DraftsPostRequest, callback: (error: ServiceError | null, response: DraftState) => void): ClientUnaryCall;
  draftsPost(request: DraftsPostRequest, metadata: Metadata, callback: (error: ServiceError | null, response: DraftState) => void): ClientUnaryCall;
  draftsPost(request: DraftsPostRequest, metadata: Metadata, options: Partial<CallOptions>, callback: (error: ServiceError | null, response: DraftState) => void): ClientUnaryCall;
  /** Removes the friend relationship between two users. */
  friendDelete(request: FriendDeleteRequest, callback: (error: ServiceError | null, response: UnfriendResponse) => void): ClientUnaryCall;
  friendDelete(request: FriendDeleteRequest, metadata: Metadata, callback: (error: ServiceError | null, response: UnfriendResponse) => void): ClientUnaryCall;
  friendDelete(request: FriendDeleteRequest, metadata: Metadata, options: Partial<CallOptions>, callback: (error: ServiceError | null, response: UnfriendResponse) => void): ClientUnaryCall;
  /** Adds a specified user to your friend list. */
  friendPut(request: FriendPutRequest, callback: (error: ServiceError | null, response: FriendPutResponse) => void): ClientUnaryCall;
  friendPut(request: FriendPutRequest, metadata: Metadata, callback: (error: ServiceError | null, response: FriendPutResponse) => void): ClientUnaryCall;
  friendPut(request: FriendPutRequest, metadata: Metadata, options: Partial<CallOptions>, callback: (error: ServiceError | null, response: FriendPutResponse) => void): ClientUnaryCall;
  /** Get a specific account. Contains more information if the userId matches the requesting user. */
  getAccount(request: GetAccountRequest, callback: (error: ServiceError | null, response: GetAccountsResponse) => void): ClientUnaryCall;
  getAccount(request: GetAccountRequest, metadata: Metadata, callback: (error: ServiceError | null, response: GetAccountsResponse) => void): ClientUnaryCall;
  getAccount(request: GetAccountRequest, metadata: Metadata, options: Partial<CallOptions>, callback: (error: ServiceError | null, response: GetAccountsResponse) => void): ClientUnaryCall;
  /** Get a list of accounts including user profile information. */
   ...
   * against other players only receive this player's point of view.
   */
  getGameRecord(request: GetGameRecordRequest, callback: (error: ServiceError | null, response: GetGameRecordResponse) => void): ClientUnaryCall;
  getGameRecord(request: GetGameRecordRequest, metadata: Metadata, callback: (error: ServiceError | null, response: GetGameRecordResponse) => void): ClientUnaryCall;
  getGameRecord(request: GetGameRecordRequest, metadata: Metadata, options: Partial<CallOptions>, callback: (error: ServiceError | null, response: GetGameRecordResponse) => void): ClientUnaryCall;
  /** Retrieves a list of game IDs corresponding to all the games this player played. */
  getGameRecordIds(request: Empty, callback: (error: ServiceError | null, response: GetGameRecordIdsResponse) => void): ClientUnaryCall;
  getGameRecordIds(request: Empty, metadata: Metadata, callback: (error: ServiceError | null, response: GetGameRecordIdsResponse) => void): ClientUnaryCall;
  getGameRecordIds(request: Empty, metadata: Metadata, options: Partial<CallOptions>, callback: (error: ServiceError | null, response: GetGameRecordIdsResponse) => void): ClientUnaryCall;
  /** Retrieves information about a specific invite, as long as this user is either the sender or recipient. */
  getInvite(request: GetInviteRequest, callback: (error: ServiceError | null, response: InviteResponse) => void): ClientUnaryCall;
  getInvite(request: GetInviteRequest, metadata: Metadata, callback: (error: ServiceError | null, response: InviteResponse) => void): ClientUnaryCall;
  getInvite(request: GetInviteRequest, metadata: Metadata, options: Partial<CallOptions>, callback: (error: ServiceError | null, response: InviteResponse) => void): ClientUnaryCall;
  /** Retrieve all invites where this user is either the sender or recipient. */
  getInvites(request: Empty, callback: (error: ServiceError | null, response: InviteGetResponse) => void): ClientUnaryCall;
  getInvites(request: Empty, metadata: Metadata, callback: (error: ServiceError | null, response: InviteGetResponse) => void): ClientUnaryCall;
  getInvites(request: Empty, metadata: Metadata, options: Partial<CallOptions>, callback: (error: ServiceError | null, response: InviteGetResponse) => void): ClientUnaryCall;
  /** Login with a username and password, receiving an authentication token to use for future sessions. */
  ...
  /** Send an invite. */
  postInvite(request: PostInviteRequest, options?: Partial<CallOptions>): ClientReadableStream<InviteResponse>;
  postInvite(request: PostInviteRequest, metadata?: Metadata, options?: Partial<CallOptions>): ClientReadableStream<InviteResponse>;
  /** Provided a valid reset token, resets a user's password. */
  postPasswordReset(request: PostPasswordResetRequest, callback: (error: ServiceError | null, response: Empty) => void): ClientUnaryCall;
  postPasswordReset(request: PostPasswordResetRequest, metadata: Metadata, callback: (error: ServiceError | null, response: Empty) => void): ClientUnaryCall;
  postPasswordReset(request: PostPasswordResetRequest, metadata: Metadata, options: Partial<CallOptions>, callback: (error: ServiceError | null, response: Empty) => void): ClientUnaryCall;
}

export const HiddenSwitchSpellsourceAPIServiceClient = makeGenericClientConstructor(HiddenSwitchSpellsourceAPIServiceService, "spellsource.HiddenSwitchSpellsourceAPIService") as unknown as {
  new (address: string, credentials: ChannelCredentials, options?: Partial<ClientOptions>): HiddenSwitchSpellsourceAPIServiceClient;
  service: typeof HiddenSwitchSpellsourceAPIServiceService;
};
