...
public class CardSet {
	...
	public static final String SAVIORS_OF_ULDUM = "SAVIORS_OF_ULDUM";
	public static final String DESCENT_OF_DRAGONS = "DESCENT_OF_DRAGONS";
	public static final String ASHES_OF_OUTLAND = "ASHES_OF_OUTLAND";
	public static final String SCHOLOMANCE_ACADEMY = "SCHOLOMANCE_ACADEMY";
	public static final String MADNESS_AT_THE_DARKMOON_FAIRE = "MADNESS_AT_THE_DARKMOON_FAIRE";
	public static final String FORGED_IN_THE_BARRENS = "FORGED_IN_THE_BARRENS";
	public static final String UNITED_IN_STORMWIND = "UNITED_IN_STORMWIND";
	public static final String FRACTURED_IN_ALTERAC_VALLEY = "FRACTURED_IN_ALTERAC_VALLEY";
	public static final String VOYAGE_TO_THE_SUNKEN_CITY = "VOYAGE_TO_THE_SUNKEN_CITY";
	public static final String MURDER_AT_CASTLE_NATHRIA = "MURDER_AT_CASTLE_NATHRIA";
	public static final String MARCH_OF_THE_LICH_KING = "MARCH_OF_THE_LICH_KING";
	public static final String FESTIVAL_OF_LEGENDS = "FESTIVAL_OF_LEGENDS";
	public static final String TITANS = "TITANS";
	public static final String SHOWDOWN_IN_THE_BADLANDS = "SHOWDOWN_IN_THE_BADLANDS";
	public static final String WHIZBANGS_WORKSHOP = "WHIZBANGS_WORKSHOP";
	public static final String PERILS_IN_PARADISE = "PERILS_IN_PARADISE";
	public static final String SPACE = "SPACE";
	public static final String EMERALD_DREAM = "EMERALD_DREAM";
	public static final String THE_LOST_CITY = "THE_LOST_CITY";
	...
	public static final String PATH_OF_ARTHAS = "PATH_OF_ARTHAS";
