...
public enum ParseValueType {
	...
	/**
	 * A string matching the name of a {@link com.hiddenswitch.spellsource.rpc.Spellsource.ZonesMessage.Zones} enum.
	 */
	CARD_LOCATION,
	/**
	...
	EVENT_TRIGGER_ARRAY,
	/**
	 * An array of {@link com.hiddenswitch.spellsource.rpc.Spellsource.ZonesMessage.Zones} enum values.
	 */
	ZONES,
	/**
