...
/**
 * Reads the {@link SpellArg#ATTRIBUTE} from the {@link SpellArg#SECONDARY_TARGET}, and puts the {@code race} (tribe)
 * specified in that attribute onto the {@code target}.
 *
 * @see StoreRaceToAttributeSpell
 */
