 ...
 * <p>
 * Every entity has an {@link EntityLocation} that starts as {@link #UNASSIGNED}. The creator of the {@link Entity}
 * object should add it to an {@link EntityZone}, which sets that entity's {@link Entity#entityLocation}.
 * <p>
 ...
 * 		already know which zone the entity is in.
 ...
 * 		GameContext}
 * @see GameState#getEntities() for a method that iterates through all the entities in all the zones for a {@link
...
public final class EntityLocation implements Serializable {
	 ...
	 * @param player The player's index, or {@link IdFactoryImpl#UNASSIGNED} if the owner is not yet known.
	...
	/**
	 * Gets the index of the player for this location, or {@link Entity#NO_OWNER} if it has not yet been assigned. (With
