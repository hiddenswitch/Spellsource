...
public final class MaxHpIncreasedEvent extends ValueEvent {
	...
	public MaxHpIncreasedEvent(GameContext context, Entity target, int amount, int sourcePlayerId) {
		super(com.hiddenswitch.spellsource.rpc.Spellsource.GameEventTypeMessage.GameEventType.MAX_HP_INCREASED, context, target.getOwner(), sourcePlayerId, target, amount);
	}
}
