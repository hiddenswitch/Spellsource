...
public class GameContext implements Cloneable, Inventory, EntityZoneTable, Comparable<GameContext> {
	...
	public GameContext(@NotNull CardCatalogue cardCatalogue) {
		this(cardCatalogue, cardCatalogue.defaultFormat());
	}

	public GameContext(@NotNull CardCatalogue cardCatalogue, @NotNull DeckFormat deckFormat) {
		Objects.requireNonNull(cardCatalogue);
	...
	public static GameContext fromDecks(long seed, List<GameDeck> decks) {
		return fromDecks(seed, decks, ClasspathCardCatalogue.INSTANCE);
	}
