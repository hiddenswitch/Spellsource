...
public class FriendTest extends SpellsourceTestBase {
	...
	@Test
	public void testFriendsApi(Vertx vertx, VertxTestContext testContext) {
		runOnFiberContext(() -> {
			var defaultApi = getApi();
			// create first account
			var createAccount1Response = createRandomAccount();
			// create second account
			var createAccount2Response = createRandomAccount();
