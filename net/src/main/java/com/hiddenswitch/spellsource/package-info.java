 ...
 * <p>
 * To easily create JSON objects, use {@link com.hiddenswitch.spellsource.util.QuickJson#json(java.lang.Object...)}. For
 ...
 * <p>
 * To add a REST method, visit {@link com.hiddenswitch.spellsource.Gateway} and read the documentation there.
 * <p>
 * To add a method available to the web socket channel, visit {@link com.hiddenswitch.spellsource.Connection} and read
 * the documentation there.
 *
 * @see com.hiddenswitch.spellsource.Games for the service that creates games and converts internal game data into a
