...
public class TestBase {
	 ...
	 * {@code AssertionError} is thrown describing the mismatch; the exception that was actually thrown can be obtained by
	...
	public static GameContext fromTwoRandomDecks(DeckFormat format, CardCatalogue cardCatalogue) {
		return GameContext.fromDecks(Arrays.asList(RandomDeck.randomDeck(format, cardCatalogue), RandomDeck.randomDeck(format, cardCatalogue)), new PlayRandomBehaviour(), new PlayRandomBehaviour(), cardCatalogue, format);
	}

	public static GameContext fromTwoRandomDecks(long seed) {
		return fromTwoRandomDecks(seed, ClasspathCardCatalogue.INSTANCE);
	}

	public static GameContext fromTwoRandomDecks(long seed, CardCatalogue cardCatalogue) {
		var random = new XORShiftRandom(seed);
		return GameContext.fromDecks(random.nextLong(), Arrays.asList(RandomDeck.randomDeck(random.nextLong(), cardCatalogue), RandomDeck.randomDeck(random.nextLong(), cardCatalogue)), cardCatalogue);
	}
	...
	public static String randomHeroCard(DeckFormat deckFormat) {
		return randomHeroCard(deckFormat, ClasspathCardCatalogue.INSTANCE);
	}
	 ...
	 * @return
	 */
	public static String randomHeroCard(DeckFormat deckFormat, CardCatalogue cardCatalogue) {
		List<String> baseHeroes = new ArrayList<>(cardCatalogue.getBaseClasses(deckFormat));
