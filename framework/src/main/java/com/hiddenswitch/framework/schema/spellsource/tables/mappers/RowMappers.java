...
public class RowMappers {
    ...
    public static Function<Row,com.hiddenswitch.framework.schema.spellsource.tables.pojos.CardDesc> getCardDescMapper() {
        return row -> {
            com.hiddenswitch.framework.schema.spellsource.tables.pojos.CardDesc pojo = new com.hiddenswitch.framework.schema.spellsource.tables.pojos.CardDesc();
