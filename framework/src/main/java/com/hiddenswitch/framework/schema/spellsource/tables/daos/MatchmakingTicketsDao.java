...
public class MatchmakingTicketsDao extends AbstractReactiveVertxDAO<MatchmakingTicketsRecord, com.hiddenswitch.framework.schema.spellsource.tables.pojos.MatchmakingTickets, String, Future<List<com.hiddenswitch.framework.schema.spellsource.tables.pojos.MatchmakingTickets>>, Future<com.hiddenswitch.framework.schema.spellsource.tables.pojos.MatchmakingTickets>, Future<Integer>, Future<String>> implements io.github.jklingsporn.vertx.jooq.classic.VertxDAO<MatchmakingTicketsRecord,com.hiddenswitch.framework.schema.spellsource.tables.pojos.MatchmakingTickets,String> {
    ...
    public MatchmakingTicketsDao(Configuration configuration, io.vertx.sqlclient.SqlClient delegate) {
        super(MatchmakingTickets.MATCHMAKING_TICKETS, com.hiddenswitch.framework.schema.spellsource.tables.pojos.MatchmakingTickets.class, new ReactiveClassicQueryExecutor<MatchmakingTicketsRecord,com.hiddenswitch.framework.schema.spellsource.tables.pojos.MatchmakingTickets,String>(configuration,delegate,com.hiddenswitch.framework.schema.spellsource.tables.mappers.RowMappers.getMatchmakingTicketsMapper()));
    }

    @Override
    protected String getId(com.hiddenswitch.framework.schema.spellsource.tables.pojos.MatchmakingTickets object) {
        return object.getId();
    }
     ...
     */
    public Future<List<com.hiddenswitch.framework.schema.spellsource.tables.pojos.MatchmakingTickets>> findManyByLastModified(Collection<OffsetDateTime> values) {
        return findManyByCondition(MatchmakingTickets.MATCHMAKING_TICKETS.LAST_MODIFIED.in(values));
    }

    /**
     * Find records that have <code>last_modified IN (values)</code> asynchronously limited by the given limit
     */
    public Future<List<com.hiddenswitch.framework.schema.spellsource.tables.pojos.MatchmakingTickets>> findManyByLastModified(Collection<OffsetDateTime> values, int limit) {
        return findManyByCondition(MatchmakingTickets.MATCHMAKING_TICKETS.LAST_MODIFIED.in(values),limit);
    }
    ...
    /**
     * Find records that have <code>assigned_at IN (values)</code> asynchronously
     */
    public Future<List<com.hiddenswitch.framework.schema.spellsource.tables.pojos.MatchmakingTickets>> findManyByAssignedAt(Collection<OffsetDateTime> values) {
        return findManyByCondition(MatchmakingTickets.MATCHMAKING_TICKETS.ASSIGNED_AT.in(values));
    }

    /**
     * Find records that have <code>assigned_at IN (values)</code> asynchronously limited by the given limit
     */
    public Future<List<com.hiddenswitch.framework.schema.spellsource.tables.pojos.MatchmakingTickets>> findManyByAssignedAt(Collection<OffsetDateTime> values, int limit) {
        return findManyByCondition(MatchmakingTickets.MATCHMAKING_TICKETS.ASSIGNED_AT.in(values),limit);
    }

    /**
     * Find records that have <code>game_id IN (values)</code> asynchronously
     */
    public Future<List<com.hiddenswitch.framework.schema.spellsource.tables.pojos.MatchmakingTickets>> findManyByGameId(Collection<Long> values) {
        return findManyByCondition(MatchmakingTickets.MATCHMAKING_TICKETS.GAME_ID.in(values));
    }

    /**
     * Find records that have <code>game_id IN (values)</code> asynchronously limited by the given limit
     */
    public Future<List<com.hiddenswitch.framework.schema.spellsource.tables.pojos.MatchmakingTickets>> findManyByGameId(Collection<Long> values, int limit) {
        return findManyByCondition(MatchmakingTickets.MATCHMAKING_TICKETS.GAME_ID.in(values),limit);
    }

    @Override
    public ReactiveClassicQueryExecutor<MatchmakingTicketsRecord,com.hiddenswitch.framework.schema.spellsource.tables.pojos.MatchmakingTickets,String> queryExecutor(){
        return (ReactiveClassicQueryExecutor<MatchmakingTicketsRecord,com.hiddenswitch.framework.schema.spellsource.tables.pojos.MatchmakingTickets,String>) super.queryExecutor();
    }
}
