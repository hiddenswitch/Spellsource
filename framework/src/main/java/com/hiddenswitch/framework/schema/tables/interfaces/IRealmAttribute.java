...
public interface IRealmAttribute extends VertxPojo, Serializable {
    ...
    /**
     * Load data from another generated Record/POJO implementing the common interface IRealmAttribute
     */
    public void from(IRealmAttribute from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IRealmAttribute
     */
