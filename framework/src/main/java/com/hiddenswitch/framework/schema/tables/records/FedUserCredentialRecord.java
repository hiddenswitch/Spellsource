...
public class FedUserCredentialRecord extends UpdatableRecordImpl<FedUserCredentialRecord> implements VertxPojo, Record11<String, byte[], String, Long, String, String, String, String, String, String, Integer>, IFedUserCredential {
    ...
    private static final long serialVersionUID = 187852138;

    /**
     * Setter for <code>public.fed_user_credential.id</code>.
     */
    @Override
    ...
    /**
     * Getter for <code>public.fed_user_credential.id</code>.
     */
    @Override
    public String getId() {
        return (String) get(0);
    ...
    /**
     * Setter for <code>public.fed_user_credential.salt</code>.
     */
    @Override
    ...
    /**
     * Getter for <code>public.fed_user_credential.salt</code>.
     */
    @Override
    public byte[] getSalt() {
        return (byte[]) get(1);
    ...
    /**
     * Setter for <code>public.fed_user_credential.type</code>.
     */
    @Override
    ...
    /**
     * Getter for <code>public.fed_user_credential.type</code>.
     */
    @Override
    ...
    /**
     * Setter for <code>public.fed_user_credential.created_date</code>.
     */
    @Override
    ...
    /**
     * Getter for <code>public.fed_user_credential.created_date</code>.
     */
    @Override
    ...
    /**
     * Setter for <code>public.fed_user_credential.user_id</code>.
     */
    @Override
    ...
    /**
     * Getter for <code>public.fed_user_credential.user_id</code>.
     */
    @Override
    ...
    /**
     * Setter for <code>public.fed_user_credential.realm_id</code>.
     */
    @Override
    ...
    /**
     * Getter for <code>public.fed_user_credential.realm_id</code>.
     */
    @Override
    ...
    /**
     * Setter for <code>public.fed_user_credential.storage_provider_id</code>.
     */
    @Override
    ...
    /**
     * Getter for <code>public.fed_user_credential.storage_provider_id</code>.
     */
    @Override
    ...
    /**
     * Setter for <code>public.fed_user_credential.user_label</code>.
     */
    @Override
    ...
    /**
     * Getter for <code>public.fed_user_credential.user_label</code>.
     */
    @Override
    ...
    /**
     * Setter for <code>public.fed_user_credential.secret_data</code>.
     */
    @Override
    ...
    /**
     * Getter for <code>public.fed_user_credential.secret_data</code>.
     */
    @Override
    ...
    /**
     * Setter for <code>public.fed_user_credential.credential_data</code>.
     */
    @Override
    ...
    /**
     * Getter for <code>public.fed_user_credential.credential_data</code>.
     */
    @Override
    ...
    /**
     * Setter for <code>public.fed_user_credential.priority</code>.
     */
    @Override
    ...
    /**
     * Getter for <code>public.fed_user_credential.priority</code>.
     */
    @Override
