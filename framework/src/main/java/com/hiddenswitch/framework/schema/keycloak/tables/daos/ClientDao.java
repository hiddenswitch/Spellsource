...
public class ClientDao extends AbstractReactiveVertxDAO<ClientRecord, com.hiddenswitch.framework.schema.keycloak.tables.pojos.Client, String, Future<List<com.hiddenswitch.framework.schema.keycloak.tables.pojos.Client>>, Future<com.hiddenswitch.framework.schema.keycloak.tables.pojos.Client>, Future<Integer>, Future<String>> implements io.github.jklingsporn.vertx.jooq.classic.VertxDAO<ClientRecord,com.hiddenswitch.framework.schema.keycloak.tables.pojos.Client,String> {
    ...
    /**
     * Find records that have <code>client_template_id IN (values)</code> asynchronously
     */
    ...
    /**
     * Find records that have <code>client_template_id IN (values)</code> asynchronously limited by the given limit
     */
    ...
    /**
     * Find records that have <code>use_template_config IN (values)</code> asynchronously
     */
    ...
    /**
     * Find records that have <code>use_template_config IN (values)</code> asynchronously limited by the given limit
     */
    ...
    /**
     * Find records that have <code>use_template_scope IN (values)</code> asynchronously
     */
    ...
    /**
     * Find records that have <code>use_template_scope IN (values)</code> asynchronously limited by the given limit
     */
    ...
    /**
     * Find records that have <code>use_template_mappers IN (values)</code> asynchronously
     */
    ...
    /**
     * Find records that have <code>use_template_mappers IN (values)</code> asynchronously limited by the given limit
     */
