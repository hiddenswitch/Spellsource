...
public class MatchmakingQueuesRecord extends UpdatableRecordImpl<MatchmakingQueuesRecord> implements VertxPojo, Record12<String, String, Boolean, Boolean, Boolean, Long, Long, Long, Boolean, Boolean, Integer, Long>, IMatchmakingQueues {

    private static final long serialVersionUID = -921312122;
    ...
    @Override
    public Row12<String, String, Boolean, Boolean, Boolean, Long, Long, Long, Boolean, Boolean, Integer, Long> valuesRow() {
    ...
    @Override
    public MatchmakingQueuesRecord values(String value1, String value2, Boolean value3, Boolean value4, Boolean value5, Long value6, Long value7, Long value8, Boolean value9, Boolean value10, Integer value11, Long value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MatchmakingQueuesRecord(String id, String name, Boolean botOpponent, Boolean privateLobby, Boolean startsAutomatically, Long stillConnectedTimeout, Long emptyLobbyTimeout, Long awaitingLobbyTimeout, Boolean once, Boolean automaticallyClose, Integer maxTicketsToProcess, Long scanFrequency) {
        super(MatchmakingQueues.MATCHMAKING_QUEUES);
