...
public class MatchmakingQueuesRecord extends UpdatableRecordImpl<MatchmakingQueuesRecord> implements VertxPojo, Record13<String, String, Boolean, Boolean, Boolean, Long, Long, Long, Boolean, Boolean, Integer, Long, Integer>, IMatchmakingQueues {

    private static final long serialVersionUID = -1840353140;
     ...
     */
    @Override
    public MatchmakingQueuesRecord setMaxTicketsToProcess(Integer value) {
        set(10, value);
        return this;
    }
     ...
     */
    @Override
    public MatchmakingQueuesRecord setScanFrequency(Long value) {
        set(11, value);
        return this;
    }
    ...
    @Override
    public Row13<String, String, Boolean, Boolean, Boolean, Long, Long, Long, Boolean, Boolean, Integer, Long, Integer> valuesRow() {
    ...
    public Field<Integer> field11() {
        return MatchmakingQueues.MATCHMAKING_QUEUES.MAX_TICKETS_TO_PROCESS;
    }

    @Override
    public Field<Long> field12() {
        return MatchmakingQueues.MATCHMAKING_QUEUES.SCAN_FREQUENCY;
    }
    ...
    public MatchmakingQueuesRecord value11(Integer value) {
        setMaxTicketsToProcess(value);
        return this;
    }

    @Override
    public MatchmakingQueuesRecord value12(Long value) {
        setScanFrequency(value);
        return this;
    }

    @Override
    public MatchmakingQueuesRecord value13(Integer value) {
        setLobbySize(value);
        return this;
    }

    @Override
    public MatchmakingQueuesRecord values(String value1, String value2, Boolean value3, Boolean value4, Boolean value5, Long value6, Long value7, Long value8, Boolean value9, Boolean value10, Integer value11, Long value12, Integer value13) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MatchmakingQueuesRecord(String id, String name, Boolean botOpponent, Boolean privateLobby, Boolean startsAutomatically, Long stillConnectedTimeout, Long emptyLobbyTimeout, Long awaitingLobbyTimeout, Boolean once, Boolean automaticallyClose, Integer maxTicketsToProcess, Long scanFrequency, Integer lobbySize) {
        super(MatchmakingQueues.MATCHMAKING_QUEUES);
        ...
        set(2, botOpponent);
        set(3, privateLobby);
        set(4, startsAutomatically);
        set(5, stillConnectedTimeout);
        set(6, emptyLobbyTimeout);
        set(7, awaitingLobbyTimeout);
        set(8, once);
        set(9, automaticallyClose);
        set(10, maxTicketsToProcess);
        set(11, scanFrequency);
        set(12, lobbySize);
    }
