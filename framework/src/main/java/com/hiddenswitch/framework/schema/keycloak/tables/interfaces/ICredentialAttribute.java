...
public interface ICredentialAttribute extends VertxPojo, Serializable {
    ...
    /**
     * Load data from another generated Record/POJO implementing the common interface ICredentialAttribute
     */
    public void from(ICredentialAttribute from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface ICredentialAttribute
     */
