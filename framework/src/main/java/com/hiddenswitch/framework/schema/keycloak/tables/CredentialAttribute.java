...
public class CredentialAttribute extends TableImpl<CredentialAttributeRecord> {
    ...
    private static final long serialVersionUID = -767758877;
     ...
     */
    public final TableField<CredentialAttributeRecord, String> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.VARCHAR(36).nullable(false), this, "");

    /**
     * The column <code>keycloak.credential_attribute.credential_id</code>.
     */
    public final TableField<CredentialAttributeRecord, String> CREDENTIAL_ID = createField(DSL.name("credential_id"), org.jooq.impl.SQLDataType.VARCHAR(36).nullable(false), this, "");

    /**
     * The column <code>keycloak.credential_attribute.name</code>.
     */
    public final TableField<CredentialAttributeRecord, String> NAME = createField(DSL.name("name"), org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>keycloak.credential_attribute.value</code>.
     */
    public final TableField<CredentialAttributeRecord, String> VALUE = createField(DSL.name("value"), org.jooq.impl.SQLDataType.VARCHAR(4000), this, "");
    ...
    /**
     * Create an aliased <code>keycloak.credential_attribute</code> table reference
     */
    ...
    @Override
    public UniqueKey<CredentialAttributeRecord> getPrimaryKey() {
        return Keys.CONSTRAINT_CREDENTIAL_ATTR;
    }

    @Override
    public List<UniqueKey<CredentialAttributeRecord>> getKeys() {
        return Arrays.<UniqueKey<CredentialAttributeRecord>>asList(Keys.CONSTRAINT_CREDENTIAL_ATTR);
    }
