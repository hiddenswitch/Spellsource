...
public class RowMappers {
    ...
    public static Function<Row,com.hiddenswitch.framework.schema.keycloak.tables.pojos.ClientDefaultRoles> getClientDefaultRolesMapper() {
        return row -> {
            com.hiddenswitch.framework.schema.keycloak.tables.pojos.ClientDefaultRoles pojo = new com.hiddenswitch.framework.schema.keycloak.tables.pojos.ClientDefaultRoles();
            pojo.setClientId(row.getString("client_id"));
    ...
    public static Function<Row,com.hiddenswitch.framework.schema.keycloak.tables.pojos.RealmDefaultRoles> getRealmDefaultRolesMapper() {
        return row -> {
            com.hiddenswitch.framework.schema.keycloak.tables.pojos.RealmDefaultRoles pojo = new com.hiddenswitch.framework.schema.keycloak.tables.pojos.RealmDefaultRoles();
            pojo.setRealmId(row.getString("realm_id"));
            pojo.setRoleId(row.getString("role_id"));
            return pojo;
        };
