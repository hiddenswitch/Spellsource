...
public class FedUserCredential extends TableImpl<FedUserCredentialRecord> {
    ...
    private static final long serialVersionUID = 1105602410;
     ...
     */
    public final TableField<FedUserCredentialRecord, String> DEVICE = createField(DSL.name("device"), org.jooq.impl.SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>keycloak.fed_user_credential.hash_iterations</code>.
     */
    public final TableField<FedUserCredentialRecord, Integer> HASH_ITERATIONS = createField(DSL.name("hash_iterations"), org.jooq.impl.SQLDataType.INTEGER, this, "");
     ...
     */
    public final TableField<FedUserCredentialRecord, String> VALUE = createField(DSL.name("value"), org.jooq.impl.SQLDataType.VARCHAR(255), this, "");
     ...
     */
    public final TableField<FedUserCredentialRecord, Integer> COUNTER = createField(DSL.name("counter"), org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>keycloak.fed_user_credential.digits</code>.
     */
    public final TableField<FedUserCredentialRecord, Integer> DIGITS = createField(DSL.name("digits"), org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.field("6", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>keycloak.fed_user_credential.period</code>.
     */
    public final TableField<FedUserCredentialRecord, Integer> PERIOD = createField(DSL.name("period"), org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.field("30", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>keycloak.fed_user_credential.algorithm</code>.
     */
    public final TableField<FedUserCredentialRecord, String> ALGORITHM = createField(DSL.name("algorithm"), org.jooq.impl.SQLDataType.VARCHAR(36).defaultValue(org.jooq.impl.DSL.field("'HmacSHA1'::character varying", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
