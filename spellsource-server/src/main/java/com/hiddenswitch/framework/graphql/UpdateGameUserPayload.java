 ...
 */
public class UpdateGameUserPayload implements java.io.Serializable {
    ...
    public UpdateGameUserPayload() {
    }

    public UpdateGameUserPayload(String clientMutationId, GameUser gameUser, Query query, GameUsersEdge gameUserEdge, Deck deckByDeckId, Game gameByGameId) {
...
unchanged and unused. May be used by a client to track mutations.
    ...
    public static UpdateGameUserPayload.Builder builder() {
        return new UpdateGameUserPayload.Builder();
    }
...
unchanged and unused. May be used by a client to track mutations.
        ...
        public UpdateGameUserPayload build() {
            return new UpdateGameUserPayload(clientMutationId, gameUser, query, gameUserEdge, deckByDeckId, gameByGameId);
        }
