 ...
 */
public class GameUserInput implements java.io.Serializable {
    ...
    public GameUserInput() {
    }

    public GameUserInput(Integer playerIndex, String gameId, String userId, String deckId, GameUserVictoryEnum victoryStatus) {
    ...
    public static GameUserInput.Builder builder() {
        return new GameUserInput.Builder();
    }
    ...
    public static class Builder {
        ...
        public GameUserInput build() {
            return new GameUserInput(playerIndex, gameId, userId, deckId, victoryStatus);
        }
