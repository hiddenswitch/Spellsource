 ...
 */
public class MatchmakingQueuePatch implements java.io.Serializable {
    ...
    public MatchmakingQueuePatch() {
    }

    public MatchmakingQueuePatch(String id, String name, Boolean botOpponent, Boolean privateLobby, Boolean startsAutomatically, String stillConnectedTimeout, String emptyLobbyTimeout, String awaitingLobbyTimeout, Boolean once, Boolean automaticallyClose, Integer lobbySize, String queueCreatedAt) {
        this.id = id;
        this.name = name;
    ...
    public static MatchmakingQueuePatch.Builder builder() {
        return new MatchmakingQueuePatch.Builder();
    }
    ...
    public static class Builder {
        ...
        public MatchmakingQueuePatch build() {
            return new MatchmakingQueuePatch(id, name, botOpponent, privateLobby, startsAutomatically, stillConnectedTimeout, emptyLobbyTimeout, awaitingLobbyTimeout, once, automaticallyClose, lobbySize, queueCreatedAt);
        }
