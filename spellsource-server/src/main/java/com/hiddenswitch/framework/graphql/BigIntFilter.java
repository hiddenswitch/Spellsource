 ...
 */
public class BigIntFilter implements java.io.Serializable {
    ...
    public BigIntFilter(Boolean isNull, String equalTo, String notEqualTo, String distinctFrom, String notDistinctFrom, java.util.List<String> in, java.util.List<String> notIn, String lessThan, String lessThanOrEqualTo, String greaterThan, String greaterThanOrEqualTo) {
        this.isNull = isNull;
    ...
    public static BigIntFilter.Builder builder() {
        return new BigIntFilter.Builder();
    }
    ...
    public static class Builder {
        ...
        public BigIntFilter build() {
            return new BigIntFilter(isNull, equalTo, notEqualTo, distinctFrom, notDistinctFrom, in, notIn, lessThan, lessThanOrEqualTo, greaterThan, greaterThanOrEqualTo);
        }
