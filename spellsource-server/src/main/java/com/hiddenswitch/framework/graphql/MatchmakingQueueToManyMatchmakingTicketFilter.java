 ...
 */
public class MatchmakingQueueToManyMatchmakingTicketFilter implements java.io.Serializable {
    ...
    public MatchmakingQueueToManyMatchmakingTicketFilter() {
    }

    public MatchmakingQueueToManyMatchmakingTicketFilter(MatchmakingTicketFilter every, MatchmakingTicketFilter some, MatchmakingTicketFilter none) {
        this.every = every;
        this.some = some;
        this.none = none;
    }
    ...
    public static MatchmakingQueueToManyMatchmakingTicketFilter.Builder builder() {
        return new MatchmakingQueueToManyMatchmakingTicketFilter.Builder();
    }
    ...
    public static class Builder {
        ...
        public MatchmakingQueueToManyMatchmakingTicketFilter build() {
            return new MatchmakingQueueToManyMatchmakingTicketFilter(every, some, none);
        }
