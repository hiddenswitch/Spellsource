 ...
 */
public class CreateDeckSharePayload implements java.io.Serializable {
    ...
    public CreateDeckSharePayload() {
    }

    public CreateDeckSharePayload(String clientMutationId, DeckShare deckShare, Query query, DeckSharesEdge deckShareEdge, Deck deckByDeckId) {
...
unchanged and unused. May be used by a client to track mutations.
    ...
    public static CreateDeckSharePayload.Builder builder() {
        return new CreateDeckSharePayload.Builder();
    }
...
unchanged and unused. May be used by a client to track mutations.
        ...
        public CreateDeckSharePayload build() {
            return new CreateDeckSharePayload(clientMutationId, deckShare, query, deckShareEdge, deckByDeckId);
        }
