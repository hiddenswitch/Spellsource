 ...
 */
public class DeckToManyCardsInDeckFilter implements java.io.Serializable {
    ...
    public DeckToManyCardsInDeckFilter() {
    }

    public DeckToManyCardsInDeckFilter(CardsInDeckFilter every, CardsInDeckFilter some, CardsInDeckFilter none) {
        this.every = every;
        this.some = some;
        this.none = none;
    }
    ...
    public static DeckToManyCardsInDeckFilter.Builder builder() {
        return new DeckToManyCardsInDeckFilter.Builder();
    }
    ...
    public static class Builder {
        ...
        public DeckToManyCardsInDeckFilter build() {
            return new DeckToManyCardsInDeckFilter(every, some, none);
        }
