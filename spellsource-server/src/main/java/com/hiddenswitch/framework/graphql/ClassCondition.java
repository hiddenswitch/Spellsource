 ...
 */
public class ClassCondition implements java.io.Serializable {
    ...
    public ClassCondition(String createdBy, String Class, Boolean isPublished, Boolean collectible, String cardScript, String id, String name) {
    ...
    public static ClassCondition.Builder builder() {
        return new ClassCondition.Builder();
    }
    ...
    public static class Builder {
        ...
        public ClassCondition build() {
            return new ClassCondition(createdBy, Class, isPublished, collectible, cardScript, id, name);
        }
