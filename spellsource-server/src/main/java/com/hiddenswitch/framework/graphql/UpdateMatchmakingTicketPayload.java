 ...
 */
public class UpdateMatchmakingTicketPayload implements java.io.Serializable {
    ...
    public UpdateMatchmakingTicketPayload() {
    }

    public UpdateMatchmakingTicketPayload(String clientMutationId, MatchmakingTicket matchmakingTicket, Query query, MatchmakingTicketsEdge matchmakingTicketEdge, Deck deckByBotDeckId, Deck deckByDeckId, MatchmakingQueue matchmakingQueueByQueueId) {
...
unchanged and unused. May be used by a client to track mutations.
    ...
    public static UpdateMatchmakingTicketPayload.Builder builder() {
        return new UpdateMatchmakingTicketPayload.Builder();
    }
...
unchanged and unused. May be used by a client to track mutations.
        ...
        public UpdateMatchmakingTicketPayload build() {
            return new UpdateMatchmakingTicketPayload(clientMutationId, matchmakingTicket, query, matchmakingTicketEdge, deckByBotDeckId, deckByDeckId, matchmakingQueueByQueueId);
        }
