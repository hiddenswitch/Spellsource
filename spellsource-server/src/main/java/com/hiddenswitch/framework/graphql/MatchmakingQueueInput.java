 ...
 */
public class MatchmakingQueueInput implements java.io.Serializable {
    ...
    public MatchmakingQueueInput() {
    }

    public MatchmakingQueueInput(String id, String name, Boolean botOpponent, Boolean privateLobby, Boolean startsAutomatically, String stillConnectedTimeout, String emptyLobbyTimeout, String awaitingLobbyTimeout, Boolean once, Boolean automaticallyClose, Integer lobbySize, String queueCreatedAt) {
        this.id = id;
        this.name = name;
    ...
    public static MatchmakingQueueInput.Builder builder() {
        return new MatchmakingQueueInput.Builder();
    }
    ...
    public static class Builder {
        ...
        public MatchmakingQueueInput build() {
            return new MatchmakingQueueInput(id, name, botOpponent, privateLobby, startsAutomatically, stillConnectedTimeout, emptyLobbyTimeout, awaitingLobbyTimeout, once, automaticallyClose, lobbySize, queueCreatedAt);
        }
