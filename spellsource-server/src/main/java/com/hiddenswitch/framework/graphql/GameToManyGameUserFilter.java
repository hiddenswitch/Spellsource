 ...
 */
public class GameToManyGameUserFilter implements java.io.Serializable {
    ...
    public GameToManyGameUserFilter() {
    }

    public GameToManyGameUserFilter(GameUserFilter every, GameUserFilter some, GameUserFilter none) {
        this.every = every;
        this.some = some;
        this.none = none;
    }
    ...
    public static GameToManyGameUserFilter.Builder builder() {
        return new GameToManyGameUserFilter.Builder();
    }
    ...
    public static class Builder {
        ...
        public GameToManyGameUserFilter build() {
            return new GameToManyGameUserFilter(every, some, none);
        }
