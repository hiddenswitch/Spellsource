 ...
 */
public class UpdateCardsInDeckPayload implements java.io.Serializable {
    ...
    public UpdateCardsInDeckPayload() {
    }

    public UpdateCardsInDeckPayload(String clientMutationId, CardsInDeck cardsInDeck, Query query, CardsInDecksEdge cardsInDeckEdge, PublishedCard publishedCardByCardId, Deck deckByDeckId) {
...
unchanged and unused. May be used by a client to track mutations.
    ...
    public static UpdateCardsInDeckPayload.Builder builder() {
        return new UpdateCardsInDeckPayload.Builder();
    }
...
unchanged and unused. May be used by a client to track mutations.
        ...
        public UpdateCardsInDeckPayload build() {
            return new UpdateCardsInDeckPayload(clientMutationId, cardsInDeck, query, cardsInDeckEdge, publishedCardByCardId, deckByDeckId);
        }
