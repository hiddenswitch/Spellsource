 ...
 */
public class DeckPatch implements java.io.Serializable {
    ...
    public DeckPatch(String id, String createdBy, String lastEditedBy, String name, String heroClass, Boolean trashed, String format, Integer deckType, Boolean isPremade, Boolean permittedToDuplicate) {
        this.id = id;
    ...
    public static DeckPatch.Builder builder() {
        return new DeckPatch.Builder();
    }
    ...
    public static class Builder {
        ...
        public DeckPatch build() {
            return new DeckPatch(id, createdBy, lastEditedBy, name, heroClass, trashed, format, deckType, isPremade, permittedToDuplicate);
        }
