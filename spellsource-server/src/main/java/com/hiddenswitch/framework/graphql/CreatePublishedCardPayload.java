 ...
 */
public class CreatePublishedCardPayload implements java.io.Serializable {
    ...
    public CreatePublishedCardPayload() {
    }

    public CreatePublishedCardPayload(String clientMutationId, PublishedCard publishedCard, Query query, PublishedCardsEdge publishedCardEdge, Card cardBySuccession) {
...
unchanged and unused. May be used by a client to track mutations.
    ...
    public static CreatePublishedCardPayload.Builder builder() {
        return new CreatePublishedCardPayload.Builder();
    }
...
unchanged and unused. May be used by a client to track mutations.
        ...
        public CreatePublishedCardPayload build() {
            return new CreatePublishedCardPayload(clientMutationId, publishedCard, query, publishedCardEdge, cardBySuccession);
        }
