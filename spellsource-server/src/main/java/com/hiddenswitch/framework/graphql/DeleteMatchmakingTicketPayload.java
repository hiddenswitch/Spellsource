 ...
 */
public class DeleteMatchmakingTicketPayload implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    private String clientMutationId;
    private MatchmakingTicket matchmakingTicket;
    private String deletedMatchmakingTicketId;
    private Query query;
    ...
    public DeleteMatchmakingTicketPayload() {
    }

    public DeleteMatchmakingTicketPayload(String clientMutationId, MatchmakingTicket matchmakingTicket, String deletedMatchmakingTicketId, Query query, MatchmakingTicketsEdge matchmakingTicketEdge, Deck deckByBotDeckId, Deck deckByDeckId, MatchmakingQueue matchmakingQueueByQueueId) {
        this.clientMutationId = clientMutationId;
        this.matchmakingTicket = matchmakingTicket;
        this.deletedMatchmakingTicketId = deletedMatchmakingTicketId;
        this.query = query;
...
unchanged and unused. May be used by a client to track mutations.
    ...
    public String getDeletedMatchmakingTicketId() {
        return deletedMatchmakingTicketId;
    }
    public void setDeletedMatchmakingTicketId(String deletedMatchmakingTicketId) {
        this.deletedMatchmakingTicketId = deletedMatchmakingTicketId;
    }
    ...
    public static DeleteMatchmakingTicketPayload.Builder builder() {
        return new DeleteMatchmakingTicketPayload.Builder();
    }
...
unchanged and unused. May be used by a client to track mutations.
        ...
        public Builder setDeletedMatchmakingTicketId(String deletedMatchmakingTicketId) {
            this.deletedMatchmakingTicketId = deletedMatchmakingTicketId;
            return this;
        }
        ...
        public DeleteMatchmakingTicketPayload build() {
            return new DeleteMatchmakingTicketPayload(clientMutationId, matchmakingTicket, deletedMatchmakingTicketId, query, matchmakingTicketEdge, deckByBotDeckId, deckByDeckId, matchmakingQueueByQueueId);
        }
