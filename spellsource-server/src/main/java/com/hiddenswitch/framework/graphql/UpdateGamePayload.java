 ...
 */
public class UpdateGamePayload implements java.io.Serializable {
    ...
    public UpdateGamePayload(String clientMutationId, Game game, Query query, GamesEdge gameEdge) {
...
unchanged and unused. May be used by a client to track mutations.
    ...
    public static UpdateGamePayload.Builder builder() {
        return new UpdateGamePayload.Builder();
    }
...
unchanged and unused. May be used by a client to track mutations.
        ...
        public UpdateGamePayload build() {
            return new UpdateGamePayload(clientMutationId, game, query, gameEdge);
        }
