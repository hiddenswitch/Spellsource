 ...
 */
public class UpdateHardRemovalCardPayload implements java.io.Serializable {
    ...
    public UpdateHardRemovalCardPayload() {
    }

    public UpdateHardRemovalCardPayload(String clientMutationId, HardRemovalCard hardRemovalCard, Query query, HardRemovalCardsEdge hardRemovalCardEdge) {
...
unchanged and unused. May be used by a client to track mutations.
    ...
    public static UpdateHardRemovalCardPayload.Builder builder() {
        return new UpdateHardRemovalCardPayload.Builder();
    }
...
unchanged and unused. May be used by a client to track mutations.
        ...
        public UpdateHardRemovalCardPayload build() {
            return new UpdateHardRemovalCardPayload(clientMutationId, hardRemovalCard, query, hardRemovalCardEdge);
        }
