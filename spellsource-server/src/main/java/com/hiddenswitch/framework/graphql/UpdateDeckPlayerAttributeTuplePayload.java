 ...
 */
public class UpdateDeckPlayerAttributeTuplePayload implements java.io.Serializable {
    ...
    public UpdateDeckPlayerAttributeTuplePayload() {
    }

    public UpdateDeckPlayerAttributeTuplePayload(String clientMutationId, DeckPlayerAttributeTuple deckPlayerAttributeTuple, Query query, DeckPlayerAttributeTuplesEdge deckPlayerAttributeTupleEdge, Deck deckByDeckId) {
...
unchanged and unused. May be used by a client to track mutations.
    ...
    public static UpdateDeckPlayerAttributeTuplePayload.Builder builder() {
        return new UpdateDeckPlayerAttributeTuplePayload.Builder();
    }
...
unchanged and unused. May be used by a client to track mutations.
        ...
        public UpdateDeckPlayerAttributeTuplePayload build() {
            return new UpdateDeckPlayerAttributeTuplePayload(clientMutationId, deckPlayerAttributeTuple, query, deckPlayerAttributeTupleEdge, deckByDeckId);
        }
