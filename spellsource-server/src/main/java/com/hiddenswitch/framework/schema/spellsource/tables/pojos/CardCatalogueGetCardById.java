...
public class CardCatalogueGetCardById implements VertxPojo, ICardCatalogueGetCardById {
     ...
     */
    @Override
    public CardCatalogueGetCardById setBlocklyWorkspace(JsonObject blocklyWorkspace) {
        this.blocklyWorkspace = blocklyWorkspace;
        return this;
    }
     ...
     */
    @Override
    public CardCatalogueGetCardById setIsPublished(Boolean isPublished) {
        this.isPublished = isPublished;
        return this;
    }
     ...
     */
    @Override
    public CardCatalogueGetCardById setSuccession(Long succession) {
        this.succession = succession;
        return this;
    }
