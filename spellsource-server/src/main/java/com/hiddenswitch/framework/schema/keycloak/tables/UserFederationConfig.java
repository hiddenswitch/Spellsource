...
public class UserFederationConfig extends TableImpl<UserFederationConfigRecord> {
    ...
    @Override
    public UserFederationConfig as(Table<?> alias) {
        return new UserFederationConfig(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public UserFederationConfig rename(Table<?> name) {
        return new UserFederationConfig(name.getQualifiedName(), null);
    }
