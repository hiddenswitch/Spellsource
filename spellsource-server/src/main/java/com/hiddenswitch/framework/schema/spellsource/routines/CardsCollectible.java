...
public class CardsCollectible extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>spellsource.cards_collectible.RETURN_VALUE</code>.
     */
    public static final Parameter<Boolean> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.BOOLEAN, false, false);

    /**
     * The parameter <code>spellsource.cards_collectible.card</code>.
     */
     ...
     */
    public CardsCollectible() {
        super("cards_collectible", Spellsource.SPELLSOURCE, SQLDataType.BOOLEAN);
     ...
     */
    public CardsCollectible setCard(Field<CardsRecord> field) {
        setField(CARD, field);
        return this;
    }
}
