...
public class CardCatalogueQueryRecord extends TableRecordImpl<CardCatalogueQueryRecord> implements VertxPojo, Record10<String, String, String, XML, JsonObject, OffsetDateTime, OffsetDateTime, Boolean, Boolean, Long>, ICardCatalogueQuery {
    ...
    @Override
    public CardCatalogueQueryRecord values(String value1, String value2, String value3, XML value4, JsonObject value5, OffsetDateTime value6, OffsetDateTime value7, Boolean value8, Boolean value9, Long value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CardCatalogueQueryRecord(String id, String createdBy, String uri, XML blocklyWorkspace, JsonObject cardScript, OffsetDateTime createdAt, OffsetDateTime lastModified, Boolean isArchived, Boolean isPublished, Long succession) {
        super(CardCatalogueQuery.CARD_CATALOGUE_QUERY);
