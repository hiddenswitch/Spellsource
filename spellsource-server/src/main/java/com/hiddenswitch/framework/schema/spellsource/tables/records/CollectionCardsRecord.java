...
public class CollectionCardsRecord extends TableRecordImpl<CollectionCardsRecord> implements VertxPojo, Record12<String, String, JsonObject, JsonObject, String, String, String, Integer, Boolean, String, OffsetDateTime, OffsetDateTime>, ICollectionCards {
     ...
     */
    @Override
    public CollectionCardsRecord setBlocklyWorkspace(JsonObject value) {
        set(3, value);
        return this;
    }
    ...
    @Override
    public CollectionCardsRecord value4(JsonObject value) {
    ...
    @Override
    public CollectionCardsRecord values(String value1, String value2, JsonObject value3, JsonObject value4, String value5, String value6, String value7, Integer value8, Boolean value9, String value10, OffsetDateTime value11, OffsetDateTime value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CollectionCardsRecord(String id, String createdBy, JsonObject cardScript, JsonObject blocklyWorkspace, String name, String type, String class_, Integer cost, Boolean collectible, String searchMessage, OffsetDateTime lastModified, OffsetDateTime createdAt) {
        super(CollectionCards.COLLECTION_CARDS);
