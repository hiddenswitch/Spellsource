...
public class UserConsentRecord extends UpdatableRecordImpl<UserConsentRecord> implements VertxPojo, Record5<String, String, String, Long, Long>, IUserConsent {
    ...
    @Override
    public UserConsentRecord values(String value1, String value2, String value3, Long value4, Long value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UserConsentRecord(String id, String clientId, String userId, Long createdDate, Long lastUpdatedDate) {
        super(UserConsent.USER_CONSENT);
