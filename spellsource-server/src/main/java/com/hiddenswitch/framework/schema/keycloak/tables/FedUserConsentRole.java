...
public class FedUserConsentRole extends TableImpl<FedUserConsentRoleRecord> {
    ...
    /**
     * The column <code>keycloak.fed_user_consent_role.user_consent_id</code>.
     */
    public final TableField<FedUserConsentRoleRecord, String> USER_CONSENT_ID = createField(DSL.name("user_consent_id"), SQLDataType.VARCHAR(36).nullable(false), this, "");

    /**
     * The column <code>keycloak.fed_user_consent_role.role_id</code>.
     */
    public final TableField<FedUserConsentRoleRecord, String> ROLE_ID = createField(DSL.name("role_id"), SQLDataType.VARCHAR(36).nullable(false), this, "");
    ...
    /**
     * Create an aliased <code>keycloak.fed_user_consent_role</code> table
     * reference
     */
    ...
    @Override
    public UniqueKey<FedUserConsentRoleRecord> getPrimaryKey() {
        return Keys.CONSTR_USER_CONSENT_ROLE_PK;
    }
