...
public class RealmDao extends AbstractReactiveVertxDAO<RealmRecord, com.hiddenswitch.framework.schema.keycloak.tables.pojos.Realm, String, Future<List<com.hiddenswitch.framework.schema.keycloak.tables.pojos.Realm>>, Future<com.hiddenswitch.framework.schema.keycloak.tables.pojos.Realm>, Future<Integer>, Future<String>> implements io.github.jklingsporn.vertx.jooq.classic.VertxDAO<RealmRecord,com.hiddenswitch.framework.schema.keycloak.tables.pojos.Realm,String> {
     ...
     */
        ...
        /**
     * Find records that have <code>refresh_token_max_reuse IN (values)</code>
     * asynchronously
     */
     ...
     */
        ...
        /**
     * Find records that have <code>allow_user_managed_access IN (values)</code>
     * asynchronously
     */
     ...
     */
        ...
        /**
     * Find records that have <code>sso_max_lifespan_remember_me IN
     * (values)</code> asynchronously
     */
     ...
     */
        ...
        /**
     * Find records that have <code>sso_idle_timeout_remember_me IN
     * (values)</code> asynchronously
     */
     ...
     */
        ...
        /**
     * Find records that have <code>default_role IN (values)</code>
     * asynchronously
     */
        public Future<List<com.hiddenswitch.framework.schema.keycloak.tables.pojos.Realm>> findManyByDefaultRole(Collection<String> values) {
                return findManyByCondition(Realm.REALM.DEFAULT_ROLE.in(values));
        }
     ...
     * asynchronously limited by the given limit
     */
        public Future<List<com.hiddenswitch.framework.schema.keycloak.tables.pojos.Realm>> findManyByDefaultRole(Collection<String> values, int limit) {
                return findManyByCondition(Realm.REALM.DEFAULT_ROLE.in(values),limit);
        }
