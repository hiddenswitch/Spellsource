...
public class ProtocolMapperConfig extends TableImpl<ProtocolMapperConfigRecord> {
    ...
    @Override
    public ProtocolMapperConfig as(Table<?> alias) {
        return new ProtocolMapperConfig(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public ProtocolMapperConfig rename(Table<?> name) {
        return new ProtocolMapperConfig(name.getQualifiedName(), null);
    }
