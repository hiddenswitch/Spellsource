...
public class UuidGenerateV3 extends AbstractRoutine<UUID> {
    ...
    public UuidGenerateV3() {
        super("uuid_generate_v3", Hiddenswitch.HIDDENSWITCH, SQLDataType.UUID);
