...
public class Keys {
    ...
    public static final UniqueKey<AdminEventEntityRecord> CONSTRAINT_ADMIN_EVENT_ENTITY = Internal.createUniqueKey(AdminEventEntity.ADMIN_EVENT_ENTITY, DSL.name("constraint_admin_event_entity"), new TableField[] { AdminEventEntity.ADMIN_EVENT_ENTITY.ID }, true);
    ...
    public static final UniqueKey<ClientAuthFlowBindingsRecord> C_CLI_FLOW_BIND = Internal.createUniqueKey(ClientAuthFlowBindings.CLIENT_AUTH_FLOW_BINDINGS, DSL.name("c_cli_flow_bind"), new TableField[] { ClientAuthFlowBindings.CLIENT_AUTH_FLOW_BINDINGS.CLIENT_ID, ClientAuthFlowBindings.CLIENT_AUTH_FLOW_BINDINGS.BINDING_NAME }, true);
    public static final UniqueKey<ClientInitialAccessRecord> CNSTR_CLIENT_INIT_ACC_PK = Internal.createUniqueKey(ClientInitialAccess.CLIENT_INITIAL_ACCESS, DSL.name("cnstr_client_init_acc_pk"), new TableField[] { ClientInitialAccess.CLIENT_INITIAL_ACCESS.ID }, true);
    ...
    public static final UniqueKey<ClientScopeRecord> PK_CLI_TEMPLATE = Internal.createUniqueKey(ClientScope.CLIENT_SCOPE, DSL.name("pk_cli_template"), new TableField[] { ClientScope.CLIENT_SCOPE.ID }, true);
    public static final UniqueKey<ClientScopeRecord> UK_CLI_SCOPE = Internal.createUniqueKey(ClientScope.CLIENT_SCOPE, DSL.name("uk_cli_scope"), new TableField[] { ClientScope.CLIENT_SCOPE.REALM_ID, ClientScope.CLIENT_SCOPE.NAME }, true);
    public static final UniqueKey<ClientScopeAttributesRecord> PK_CL_TMPL_ATTR = Internal.createUniqueKey(ClientScopeAttributes.CLIENT_SCOPE_ATTRIBUTES, DSL.name("pk_cl_tmpl_attr"), new TableField[] { ClientScopeAttributes.CLIENT_SCOPE_ATTRIBUTES.SCOPE_ID, ClientScopeAttributes.CLIENT_SCOPE_ATTRIBUTES.NAME }, true);
    public static final UniqueKey<ClientScopeClientRecord> C_CLI_SCOPE_BIND = Internal.createUniqueKey(ClientScopeClient.CLIENT_SCOPE_CLIENT, DSL.name("c_cli_scope_bind"), new TableField[] { ClientScopeClient.CLIENT_SCOPE_CLIENT.CLIENT_ID, ClientScopeClient.CLIENT_SCOPE_CLIENT.SCOPE_ID }, true);
    public static final UniqueKey<ClientScopeRoleMappingRecord> PK_TEMPLATE_SCOPE = Internal.createUniqueKey(ClientScopeRoleMapping.CLIENT_SCOPE_ROLE_MAPPING, DSL.name("pk_template_scope"), new TableField[] { ClientScopeRoleMapping.CLIENT_SCOPE_ROLE_MAPPING.SCOPE_ID, ClientScopeRoleMapping.CLIENT_SCOPE_ROLE_MAPPING.ROLE_ID }, true);
    ...
    public static final UniqueKey<CompositeRoleRecord> CONSTRAINT_COMPOSITE_ROLE = Internal.createUniqueKey(CompositeRole.COMPOSITE_ROLE, DSL.name("constraint_composite_role"), new TableField[] { CompositeRole.COMPOSITE_ROLE.COMPOSITE, CompositeRole.COMPOSITE_ROLE.CHILD_ROLE }, true);
    ...
    public static final UniqueKey<DefaultClientScopeRecord> R_DEF_CLI_SCOPE_BIND = Internal.createUniqueKey(DefaultClientScope.DEFAULT_CLIENT_SCOPE, DSL.name("r_def_cli_scope_bind"), new TableField[] { DefaultClientScope.DEFAULT_CLIENT_SCOPE.REALM_ID, DefaultClientScope.DEFAULT_CLIENT_SCOPE.SCOPE_ID }, true);
    ...
    public static final UniqueKey<FedUserConsentClScopeRecord> CONSTRAINT_FGRNTCSNT_CLSC_PM = Internal.createUniqueKey(FedUserConsentClScope.FED_USER_CONSENT_CL_SCOPE, DSL.name("constraint_fgrntcsnt_clsc_pm"), new TableField[] { FedUserConsentClScope.FED_USER_CONSENT_CL_SCOPE.USER_CONSENT_ID, FedUserConsentClScope.FED_USER_CONSENT_CL_SCOPE.SCOPE_ID }, true);
    ...
    public static final UniqueKey<RealmDefaultGroupsRecord> CONSTR_REALM_DEFAULT_GROUPS = Internal.createUniqueKey(RealmDefaultGroups.REALM_DEFAULT_GROUPS, DSL.name("constr_realm_default_groups"), new TableField[] { RealmDefaultGroups.REALM_DEFAULT_GROUPS.REALM_ID, RealmDefaultGroups.REALM_DEFAULT_GROUPS.GROUP_ID }, true);
    public static final UniqueKey<RealmEnabledEventTypesRecord> CONSTR_REALM_ENABL_EVENT_TYPES = Internal.createUniqueKey(RealmEnabledEventTypes.REALM_ENABLED_EVENT_TYPES, DSL.name("constr_realm_enabl_event_types"), new TableField[] { RealmEnabledEventTypes.REALM_ENABLED_EVENT_TYPES.REALM_ID, RealmEnabledEventTypes.REALM_ENABLED_EVENT_TYPES.VALUE }, true);
    public static final UniqueKey<RealmEventsListenersRecord> CONSTR_REALM_EVENTS_LISTENERS = Internal.createUniqueKey(RealmEventsListeners.REALM_EVENTS_LISTENERS, DSL.name("constr_realm_events_listeners"), new TableField[] { RealmEventsListeners.REALM_EVENTS_LISTENERS.REALM_ID, RealmEventsListeners.REALM_EVENTS_LISTENERS.VALUE }, true);
    public static final UniqueKey<RealmLocalizationsRecord> REALM_LOCALIZATIONS_PKEY = Internal.createUniqueKey(RealmLocalizations.REALM_LOCALIZATIONS, DSL.name("realm_localizations_pkey"), new TableField[] { RealmLocalizations.REALM_LOCALIZATIONS.REALM_ID, RealmLocalizations.REALM_LOCALIZATIONS.LOCALE }, true);
    ...
    public static final UniqueKey<RealmSupportedLocalesRecord> CONSTR_REALM_SUPPORTED_LOCALES = Internal.createUniqueKey(RealmSupportedLocales.REALM_SUPPORTED_LOCALES, DSL.name("constr_realm_supported_locales"), new TableField[] { RealmSupportedLocales.REALM_SUPPORTED_LOCALES.REALM_ID, RealmSupportedLocales.REALM_SUPPORTED_LOCALES.VALUE }, true);
    public static final UniqueKey<RedirectUrisRecord> CONSTRAINT_REDIRECT_URIS = Internal.createUniqueKey(RedirectUris.REDIRECT_URIS, DSL.name("constraint_redirect_uris"), new TableField[] { RedirectUris.REDIRECT_URIS.CLIENT_ID, RedirectUris.REDIRECT_URIS.VALUE }, true);
    ...
    public static final UniqueKey<ResourceAttributeRecord> RES_ATTR_PK = Internal.createUniqueKey(ResourceAttribute.RESOURCE_ATTRIBUTE, DSL.name("res_attr_pk"), new TableField[] { ResourceAttribute.RESOURCE_ATTRIBUTE.ID }, true);
    ...
    public static final UniqueKey<ResourceServerRecord> PK_RESOURCE_SERVER = Internal.createUniqueKey(ResourceServer.RESOURCE_SERVER, DSL.name("pk_resource_server"), new TableField[] { ResourceServer.RESOURCE_SERVER.ID }, true);
    public static final UniqueKey<ResourceServerPermTicketRecord> CONSTRAINT_FAPMT = Internal.createUniqueKey(ResourceServerPermTicket.RESOURCE_SERVER_PERM_TICKET, DSL.name("constraint_fapmt"), new TableField[] { ResourceServerPermTicket.RESOURCE_SERVER_PERM_TICKET.ID }, true);
    public static final UniqueKey<ResourceServerPermTicketRecord> UK_FRSR6T700S9V50BU18WS5PMT = Internal.createUniqueKey(ResourceServerPermTicket.RESOURCE_SERVER_PERM_TICKET, DSL.name("uk_frsr6t700s9v50bu18ws5pmt"), new TableField[] { ResourceServerPermTicket.RESOURCE_SERVER_PERM_TICKET.OWNER, ResourceServerPermTicket.RESOURCE_SERVER_PERM_TICKET.REQUESTER, ResourceServerPermTicket.RESOURCE_SERVER_PERM_TICKET.RESOURCE_SERVER_ID, ResourceServerPermTicket.RESOURCE_SERVER_PERM_TICKET.RESOURCE_ID, ResourceServerPermTicket.RESOURCE_SERVER_PERM_TICKET.SCOPE_ID }, true);
    ...
    public static final UniqueKey<ResourceUrisRecord> CONSTRAINT_RESOUR_URIS_PK = Internal.createUniqueKey(ResourceUris.RESOURCE_URIS, DSL.name("constraint_resour_uris_pk"), new TableField[] { ResourceUris.RESOURCE_URIS.RESOURCE_ID, ResourceUris.RESOURCE_URIS.VALUE }, true);
    public static final UniqueKey<RoleAttributeRecord> CONSTRAINT_ROLE_ATTRIBUTE_PK = Internal.createUniqueKey(RoleAttribute.ROLE_ATTRIBUTE, DSL.name("constraint_role_attribute_pk"), new TableField[] { RoleAttribute.ROLE_ATTRIBUTE.ID }, true);
    ...
    public static final UniqueKey<UserConsentRecord> UK_JKUWUVD56ONTGSUHOGM8UEWRT = Internal.createUniqueKey(UserConsent.USER_CONSENT, DSL.name("uk_jkuwuvd56ontgsuhogm8uewrt"), new TableField[] { UserConsent.USER_CONSENT.CLIENT_ID, UserConsent.USER_CONSENT.CLIENT_STORAGE_PROVIDER, UserConsent.USER_CONSENT.EXTERNAL_CLIENT_ID, UserConsent.USER_CONSENT.USER_ID }, true);
    public static final UniqueKey<UserConsentClientScopeRecord> CONSTRAINT_GRNTCSNT_CLSC_PM = Internal.createUniqueKey(UserConsentClientScope.USER_CONSENT_CLIENT_SCOPE, DSL.name("constraint_grntcsnt_clsc_pm"), new TableField[] { UserConsentClientScope.USER_CONSENT_CLIENT_SCOPE.USER_CONSENT_ID, UserConsentClientScope.USER_CONSENT_CLIENT_SCOPE.SCOPE_ID }, true);
    ...
    public static final UniqueKey<WebOriginsRecord> CONSTRAINT_WEB_ORIGINS = Internal.createUniqueKey(WebOrigins.WEB_ORIGINS, DSL.name("constraint_web_origins"), new TableField[] { WebOrigins.WEB_ORIGINS.CLIENT_ID, WebOrigins.WEB_ORIGINS.VALUE }, true);
    ...
    public static final ForeignKey<ClientInitialAccessRecord, RealmRecord> CLIENT_INITIAL_ACCESS__FK_CLIENT_INIT_ACC_REALM = Internal.createForeignKey(ClientInitialAccess.CLIENT_INITIAL_ACCESS, DSL.name("fk_client_init_acc_realm"), new TableField[] { ClientInitialAccess.CLIENT_INITIAL_ACCESS.REALM_ID }, Keys.CONSTRAINT_4A, new TableField[] { Realm.REALM.ID }, true);
    ...
    public static final ForeignKey<ClientScopeAttributesRecord, ClientScopeRecord> CLIENT_SCOPE_ATTRIBUTES__FK_CL_SCOPE_ATTR_SCOPE = Internal.createForeignKey(ClientScopeAttributes.CLIENT_SCOPE_ATTRIBUTES, DSL.name("fk_cl_scope_attr_scope"), new TableField[] { ClientScopeAttributes.CLIENT_SCOPE_ATTRIBUTES.SCOPE_ID }, Keys.PK_CLI_TEMPLATE, new TableField[] { ClientScope.CLIENT_SCOPE.ID }, true);
    public static final ForeignKey<ClientScopeRoleMappingRecord, ClientScopeRecord> CLIENT_SCOPE_ROLE_MAPPING__FK_CL_SCOPE_RM_SCOPE = Internal.createForeignKey(ClientScopeRoleMapping.CLIENT_SCOPE_ROLE_MAPPING, DSL.name("fk_cl_scope_rm_scope"), new TableField[] { ClientScopeRoleMapping.CLIENT_SCOPE_ROLE_MAPPING.SCOPE_ID }, Keys.PK_CLI_TEMPLATE, new TableField[] { ClientScope.CLIENT_SCOPE.ID }, true);
    ...
    public static final ForeignKey<DefaultClientScopeRecord, RealmRecord> DEFAULT_CLIENT_SCOPE__FK_R_DEF_CLI_SCOPE_REALM = Internal.createForeignKey(DefaultClientScope.DEFAULT_CLIENT_SCOPE, DSL.name("fk_r_def_cli_scope_realm"), new TableField[] { DefaultClientScope.DEFAULT_CLIENT_SCOPE.REALM_ID }, Keys.CONSTRAINT_4A, new TableField[] { Realm.REALM.ID }, true);
    ...
    public static final ForeignKey<ProtocolMapperRecord, ClientScopeRecord> PROTOCOL_MAPPER__FK_CLI_SCOPE_MAPPER = Internal.createForeignKey(ProtocolMapper.PROTOCOL_MAPPER, DSL.name("fk_cli_scope_mapper"), new TableField[] { ProtocolMapper.PROTOCOL_MAPPER.CLIENT_SCOPE_ID }, Keys.PK_CLI_TEMPLATE, new TableField[] { ClientScope.CLIENT_SCOPE.ID }, true);
    ...
    public static final ForeignKey<ResourceServerPermTicketRecord, ResourceServerRecord> RESOURCE_SERVER_PERM_TICKET__FK_FRSRHO213XCX4WNKOG82SSPMT = Internal.createForeignKey(ResourceServerPermTicket.RESOURCE_SERVER_PERM_TICKET, DSL.name("fk_frsrho213xcx4wnkog82sspmt"), new TableField[] { ResourceServerPermTicket.RESOURCE_SERVER_PERM_TICKET.RESOURCE_SERVER_ID }, Keys.PK_RESOURCE_SERVER, new TableField[] { ResourceServer.RESOURCE_SERVER.ID }, true);
    public static final ForeignKey<ResourceServerPermTicketRecord, ResourceServerResourceRecord> RESOURCE_SERVER_PERM_TICKET__FK_FRSRHO213XCX4WNKOG83SSPMT = Internal.createForeignKey(ResourceServerPermTicket.RESOURCE_SERVER_PERM_TICKET, DSL.name("fk_frsrho213xcx4wnkog83sspmt"), new TableField[] { ResourceServerPermTicket.RESOURCE_SERVER_PERM_TICKET.RESOURCE_ID }, Keys.CONSTRAINT_FARSR, new TableField[] { ResourceServerResource.RESOURCE_SERVER_RESOURCE.ID }, true);
    public static final ForeignKey<ResourceServerPermTicketRecord, ResourceServerScopeRecord> RESOURCE_SERVER_PERM_TICKET__FK_FRSRHO213XCX4WNKOG84SSPMT = Internal.createForeignKey(ResourceServerPermTicket.RESOURCE_SERVER_PERM_TICKET, DSL.name("fk_frsrho213xcx4wnkog84sspmt"), new TableField[] { ResourceServerPermTicket.RESOURCE_SERVER_PERM_TICKET.SCOPE_ID }, Keys.CONSTRAINT_FARSRS, new TableField[] { ResourceServerScope.RESOURCE_SERVER_SCOPE.ID }, true);
    public static final ForeignKey<ResourceServerPermTicketRecord, ResourceServerPolicyRecord> RESOURCE_SERVER_PERM_TICKET__FK_FRSRPO2128CX4WNKOG82SSRFY = Internal.createForeignKey(ResourceServerPermTicket.RESOURCE_SERVER_PERM_TICKET, DSL.name("fk_frsrpo2128cx4wnkog82ssrfy"), new TableField[] { ResourceServerPermTicket.RESOURCE_SERVER_PERM_TICKET.POLICY_ID }, Keys.CONSTRAINT_FARSRP, new TableField[] { ResourceServerPolicy.RESOURCE_SERVER_POLICY.ID }, true);
    public static final ForeignKey<ResourceServerPolicyRecord, ResourceServerRecord> RESOURCE_SERVER_POLICY__FK_FRSRPO213XCX4WNKOG82SSRFY = Internal.createForeignKey(ResourceServerPolicy.RESOURCE_SERVER_POLICY, DSL.name("fk_frsrpo213xcx4wnkog82ssrfy"), new TableField[] { ResourceServerPolicy.RESOURCE_SERVER_POLICY.RESOURCE_SERVER_ID }, Keys.PK_RESOURCE_SERVER, new TableField[] { ResourceServer.RESOURCE_SERVER.ID }, true);
    public static final ForeignKey<ResourceServerResourceRecord, ResourceServerRecord> RESOURCE_SERVER_RESOURCE__FK_FRSRHO213XCX4WNKOG82SSRFY = Internal.createForeignKey(ResourceServerResource.RESOURCE_SERVER_RESOURCE, DSL.name("fk_frsrho213xcx4wnkog82ssrfy"), new TableField[] { ResourceServerResource.RESOURCE_SERVER_RESOURCE.RESOURCE_SERVER_ID }, Keys.PK_RESOURCE_SERVER, new TableField[] { ResourceServer.RESOURCE_SERVER.ID }, true);
    public static final ForeignKey<ResourceServerScopeRecord, ResourceServerRecord> RESOURCE_SERVER_SCOPE__FK_FRSRSO213XCX4WNKOG82SSRFY = Internal.createForeignKey(ResourceServerScope.RESOURCE_SERVER_SCOPE, DSL.name("fk_frsrso213xcx4wnkog82ssrfy"), new TableField[] { ResourceServerScope.RESOURCE_SERVER_SCOPE.RESOURCE_SERVER_ID }, Keys.PK_RESOURCE_SERVER, new TableField[] { ResourceServer.RESOURCE_SERVER.ID }, true);
    public static final ForeignKey<ResourceUrisRecord, ResourceServerResourceRecord> RESOURCE_URIS__FK_RESOURCE_SERVER_URIS = Internal.createForeignKey(ResourceUris.RESOURCE_URIS, DSL.name("fk_resource_server_uris"), new TableField[] { ResourceUris.RESOURCE_URIS.RESOURCE_ID }, Keys.CONSTRAINT_FARSR, new TableField[] { ResourceServerResource.RESOURCE_SERVER_RESOURCE.ID }, true);
    public static final ForeignKey<RoleAttributeRecord, KeycloakRoleRecord> ROLE_ATTRIBUTE__FK_ROLE_ATTRIBUTE_ID = Internal.createForeignKey(RoleAttribute.ROLE_ATTRIBUTE, DSL.name("fk_role_attribute_id"), new TableField[] { RoleAttribute.ROLE_ATTRIBUTE.ROLE_ID }, Keys.CONSTRAINT_A, new TableField[] { KeycloakRole.KEYCLOAK_ROLE.ID }, true);
    ...
    public static final ForeignKey<UserConsentClientScopeRecord, UserConsentRecord> USER_CONSENT_CLIENT_SCOPE__FK_GRNTCSNT_CLSC_USC = Internal.createForeignKey(UserConsentClientScope.USER_CONSENT_CLIENT_SCOPE, DSL.name("fk_grntcsnt_clsc_usc"), new TableField[] { UserConsentClientScope.USER_CONSENT_CLIENT_SCOPE.USER_CONSENT_ID }, Keys.CONSTRAINT_GRNTCSNT_PM, new TableField[] { UserConsent.USER_CONSENT.ID }, true);
