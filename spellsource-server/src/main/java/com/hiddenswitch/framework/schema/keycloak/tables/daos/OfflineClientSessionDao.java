...
public class OfflineClientSessionDao extends AbstractReactiveVertxDAO<OfflineClientSessionRecord, com.hiddenswitch.framework.schema.keycloak.tables.pojos.OfflineClientSession, Record5<String, String, String, String, String>, Future<List<com.hiddenswitch.framework.schema.keycloak.tables.pojos.OfflineClientSession>>, Future<com.hiddenswitch.framework.schema.keycloak.tables.pojos.OfflineClientSession>, Future<Integer>, Future<Record5<String, String, String, String, String>>> implements io.github.jklingsporn.vertx.jooq.classic.VertxDAO<OfflineClientSessionRecord,com.hiddenswitch.framework.schema.keycloak.tables.pojos.OfflineClientSession,Record5<String, String, String, String, String>> {
    ...
    public OfflineClientSessionDao(Configuration configuration, io.vertx.sqlclient.SqlClient delegate) {
        super(OfflineClientSession.OFFLINE_CLIENT_SESSION, com.hiddenswitch.framework.schema.keycloak.tables.pojos.OfflineClientSession.class, new ReactiveClassicQueryExecutor<OfflineClientSessionRecord,com.hiddenswitch.framework.schema.keycloak.tables.pojos.OfflineClientSession,Record5<String, String, String, String, String>>(configuration,delegate,com.hiddenswitch.framework.schema.keycloak.tables.mappers.RowMappers.getOfflineClientSessionMapper()));
    }

    @Override
    protected Record5<String, String, String, String, String> getId(com.hiddenswitch.framework.schema.keycloak.tables.pojos.OfflineClientSession object) {
    ...
    @Override
    public ReactiveClassicQueryExecutor<OfflineClientSessionRecord,com.hiddenswitch.framework.schema.keycloak.tables.pojos.OfflineClientSession,Record5<String, String, String, String, String>> queryExecutor(){
        return (ReactiveClassicQueryExecutor<OfflineClientSessionRecord,com.hiddenswitch.framework.schema.keycloak.tables.pojos.OfflineClientSession,Record5<String, String, String, String, String>>) super.queryExecutor();
    }
}
