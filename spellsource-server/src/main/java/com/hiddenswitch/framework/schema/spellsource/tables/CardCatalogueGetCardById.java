...
public class CardCatalogueGetCardById extends TableImpl<CardCatalogueGetCardByIdRecord> {
     ...
     */
    public final TableField<CardCatalogueGetCardByIdRecord, JsonObject> BLOCKLY_WORKSPACE = createField(DSL.name("blockly_workspace"), SQLDataType.JSONB, this, "", new JSONBToJsonObjectConverter());
