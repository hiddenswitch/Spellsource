...
public class CardCatalogueGetCardById extends TableImpl<CardCatalogueGetCardByIdRecord> {
     ...
     */
    public final TableField<CardCatalogueGetCardByIdRecord, Boolean> IS_PRIVATE = createField(DSL.name("is_private"), SQLDataType.BOOLEAN.nullable(false).defaultValue(DSL.field("true", SQLDataType.BOOLEAN)), this, "");
