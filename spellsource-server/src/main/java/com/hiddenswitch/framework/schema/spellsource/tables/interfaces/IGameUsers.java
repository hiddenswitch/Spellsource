...
public interface IGameUsers extends VertxPojo, Serializable {
    ...
    public <E extends IGameUsers> E into(E into);
        ...
        public default IGameUsers fromJson(io.vertx.core.json.JsonObject json) {
                setOrThrow(this::setPlayerIndex,key -> {Integer i = json.getInteger(key); return i==null?null:i.shortValue();},"player_index","java.lang.Short");
                setOrThrow(this::setGameId,json::getLong,"game_id","java.lang.Long");
                ...
                setOrThrow(this::setVictoryStatus,key -> java.util.Arrays.stream(com.hiddenswitch.framework.schema.spellsource.enums.GameUserVictoryEnum.values()).filter(td -> td.getLiteral().equals(json.getString(key))).findFirst().orElse(null),"victory_status","com.hiddenswitch.framework.schema.spellsource.enums.GameUserVictoryEnum");
                return this;
        }
