...
public class CardCatalogueQuery implements VertxPojo, ICardCatalogueQuery {
     ...
     */
    @Override
    public CardCatalogueQuery setBlocklyWorkspace(JsonObject blocklyWorkspace) {
        this.blocklyWorkspace = blocklyWorkspace;
        return this;
    }
     ...
     */
    @Override
    public CardCatalogueQuery setIsPublished(Boolean isPublished) {
        this.isPublished = isPublished;
        return this;
    }
     ...
     */
    @Override
    public CardCatalogueQuery setSuccession(Long succession) {
        this.succession = succession;
        return this;
    }
