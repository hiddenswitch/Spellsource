...
public class CardCatalogueQuery implements VertxPojo, ICardCatalogueQuery {
    ...
    public CardCatalogueQuery(ICardCatalogueQuery value) {
        this.id = value.getId();
    ...
    public CardCatalogueQuery(
        ...
        public CardCatalogueQuery(io.vertx.core.json.JsonObject json) {
                this();
                fromJson(json);
        }
     ...
     */
    @Override
    public CardCatalogueQuery setId(String id) {
        this.id = id;
        return this;
    }
     ...
     */
    @Override
    public CardCatalogueQuery setCreatedBy(String createdBy) {
        this.createdBy = createdBy;
        return this;
    }
     ...
     */
    @Override
    public CardCatalogueQuery setUri(String uri) {
        this.uri = uri;
        return this;
    }
     ...
     */
    @Override
    public CardCatalogueQuery setBlocklyWorkspace(XML blocklyWorkspace) {
        this.blocklyWorkspace = blocklyWorkspace;
        return this;
    }
     ...
     */
    @Override
    public CardCatalogueQuery setCardScript(JsonObject cardScript) {
        this.cardScript = cardScript;
        return this;
    }
     ...
     */
    @Override
    public CardCatalogueQuery setCreatedAt(OffsetDateTime createdAt) {
        this.createdAt = createdAt;
        return this;
    }
     ...
     */
    @Override
    public CardCatalogueQuery setLastModified(OffsetDateTime lastModified) {
        this.lastModified = lastModified;
        return this;
    }
     ...
     */
    @Override
    public CardCatalogueQuery setIsArchived(Boolean isArchived) {
        this.isArchived = isArchived;
        return this;
    }
     ...
     */
    @Override
    public CardCatalogueQuery setIsPrivate(Boolean isPrivate) {
        this.isPrivate = isPrivate;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final CardCatalogueQuery other = (CardCatalogueQuery) obj;
        if (this.id == null) {
            if (other.id != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("CardCatalogueQuery (");
