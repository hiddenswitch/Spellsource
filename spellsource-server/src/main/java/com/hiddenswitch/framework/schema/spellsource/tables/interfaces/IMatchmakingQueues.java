...
public interface IMatchmakingQueues extends VertxPojo, Serializable {
    ...
    public <E extends IMatchmakingQueues> E into(E into);
        ...
        public default IMatchmakingQueues fromJson(io.vertx.core.json.JsonObject json) {
                ...
                setOrThrow(this::setBotOpponent,json::getBoolean,"bot_opponent","java.lang.Boolean");
                setOrThrow(this::setPrivateLobby,json::getBoolean,"private_lobby","java.lang.Boolean");
                setOrThrow(this::setStartsAutomatically,json::getBoolean,"starts_automatically","java.lang.Boolean");
                setOrThrow(this::setStillConnectedTimeout,json::getLong,"still_connected_timeout","java.lang.Long");
                setOrThrow(this::setEmptyLobbyTimeout,json::getLong,"empty_lobby_timeout","java.lang.Long");
                setOrThrow(this::setAwaitingLobbyTimeout,json::getLong,"awaiting_lobby_timeout","java.lang.Long");
                setOrThrow(this::setOnce,json::getBoolean,"once","java.lang.Boolean");
                setOrThrow(this::setAutomaticallyClose,json::getBoolean,"automatically_close","java.lang.Boolean");
                setOrThrow(this::setLobbySize,json::getInteger,"lobby_size","java.lang.Integer");
                setOrThrow(this::setQueueCreatedAt,key -> {String s = json.getString(key); return s==null?null:java.time.OffsetDateTime.parse(s);},"queue_created_at","java.time.OffsetDateTime");
                return this;
        }
