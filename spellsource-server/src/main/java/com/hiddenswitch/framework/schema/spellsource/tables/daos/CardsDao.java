...
public class CardsDao extends AbstractReactiveVertxDAO<CardsRecord, com.hiddenswitch.framework.schema.spellsource.tables.pojos.Cards, Long, Future<List<com.hiddenswitch.framework.schema.spellsource.tables.pojos.Cards>>, Future<com.hiddenswitch.framework.schema.spellsource.tables.pojos.Cards>, Future<Integer>, Future<Long>> implements io.github.jklingsporn.vertx.jooq.classic.VertxDAO<CardsRecord,com.hiddenswitch.framework.schema.spellsource.tables.pojos.Cards,Long> {
     ...
     */
        public CardsDao(Configuration configuration, io.vertx.sqlclient.SqlClient delegate) {
                super(Cards.CARDS, com.hiddenswitch.framework.schema.spellsource.tables.pojos.Cards.class, new ReactiveClassicQueryExecutor<CardsRecord,com.hiddenswitch.framework.schema.spellsource.tables.pojos.Cards,Long>(configuration,delegate,com.hiddenswitch.framework.schema.spellsource.tables.mappers.RowMappers.getCardsMapper()));
        }

        @Override
        protected Long getId(com.hiddenswitch.framework.schema.spellsource.tables.pojos.Cards object) {
                return object.getSuccession();
        }

        /**
     * Find records that have <code>id IN (values)</code> asynchronously
     */
        public Future<List<com.hiddenswitch.framework.schema.spellsource.tables.pojos.Cards>> findManyById(Collection<String> values) {
                return findManyByCondition(Cards.CARDS.ID.in(values));
        }

        /**
     * Find records that have <code>id IN (values)</code> asynchronously limited
     * by the given limit
     */
        public Future<List<com.hiddenswitch.framework.schema.spellsource.tables.pojos.Cards>> findManyById(Collection<String> values, int limit) {
     ...
     */
        ...
        /**
     * Find records that have <code>is_published IN (values)</code>
     * asynchronously
     */
        public Future<List<com.hiddenswitch.framework.schema.spellsource.tables.pojos.Cards>> findManyByIsPublished(Collection<Boolean> values) {
                return findManyByCondition(Cards.CARDS.IS_PUBLISHED.in(values));
        }
     ...
     * asynchronously limited by the given limit
     */
        public Future<List<com.hiddenswitch.framework.schema.spellsource.tables.pojos.Cards>> findManyByIsPublished(Collection<Boolean> values, int limit) {
                return findManyByCondition(Cards.CARDS.IS_PUBLISHED.in(values),limit);
        }

        /**
     * Find a unique record that has <code>id = value</code> asynchronously
     */
        public Future<com.hiddenswitch.framework.schema.spellsource.tables.pojos.Cards> findOneById(String value) {
                return findOneByCondition(Cards.CARDS.ID.eq(value));
        }

        @Override
        public ReactiveClassicQueryExecutor<CardsRecord,com.hiddenswitch.framework.schema.spellsource.tables.pojos.Cards,Long> queryExecutor(){
                return (ReactiveClassicQueryExecutor<CardsRecord,com.hiddenswitch.framework.schema.spellsource.tables.pojos.Cards,Long>) super.queryExecutor();
        }
}
