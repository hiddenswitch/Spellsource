...
public class AssociatedPolicy extends TableImpl<AssociatedPolicyRecord> {
    ...
    @Override
    public AssociatedPolicy as(Table<?> alias) {
        return new AssociatedPolicy(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public AssociatedPolicy rename(Table<?> name) {
        return new AssociatedPolicy(name.getQualifiedName(), null);
    }
