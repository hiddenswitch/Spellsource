...
public class CardCatalogueGetClassCardsRecord extends TableRecordImpl<CardCatalogueGetClassCardsRecord> implements VertxPojo, Record10<String, String, String, XML, JsonObject, OffsetDateTime, OffsetDateTime, Boolean, Boolean, Long>, ICardCatalogueGetClassCards {
    ...
    @Override
    public CardCatalogueGetClassCardsRecord values(String value1, String value2, String value3, XML value4, JsonObject value5, OffsetDateTime value6, OffsetDateTime value7, Boolean value8, Boolean value9, Long value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CardCatalogueGetClassCardsRecord(String id, String createdBy, String uri, XML blocklyWorkspace, JsonObject cardScript, OffsetDateTime createdAt, OffsetDateTime lastModified, Boolean isArchived, Boolean isPublished, Long succession) {
        super(CardCatalogueGetClassCards.CARD_CATALOGUE_GET_CLASS_CARDS);
