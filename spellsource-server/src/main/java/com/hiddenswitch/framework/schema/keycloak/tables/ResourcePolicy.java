...
public class ResourcePolicy extends TableImpl<ResourcePolicyRecord> {
    ...
    @Override
    public ResourcePolicy as(Table<?> alias) {
        return new ResourcePolicy(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public ResourcePolicy rename(Table<?> name) {
        return new ResourcePolicy(name.getQualifiedName(), null);
    }
