...
public class RealmEnabledEventTypesRecord extends TableRecordImpl<RealmEnabledEventTypesRecord> implements VertxPojo, Record2<String, String>, IRealmEnabledEventTypes {
     ...
     * Create a detached, initialised RealmEnabledEventTypesRecord
     */
    public RealmEnabledEventTypesRecord(com.hiddenswitch.framework.schema.keycloak.tables.pojos.RealmEnabledEventTypes value) {
        super(RealmEnabledEventTypes.REALM_ENABLED_EVENT_TYPES);
