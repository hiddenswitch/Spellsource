...
public class CardCatalogueGetClassCards implements VertxPojo, ICardCatalogueGetClassCards {
    ...
    public CardCatalogueGetClassCards(ICardCatalogueGetClassCards value) {
        this.id = value.getId();
    ...
    public CardCatalogueGetClassCards(
        ...
        public CardCatalogueGetClassCards(io.vertx.core.json.JsonObject json) {
                this();
                fromJson(json);
        }
     ...
     */
    @Override
    public CardCatalogueGetClassCards setId(String id) {
        this.id = id;
        return this;
    }
     ...
     */
    @Override
    public CardCatalogueGetClassCards setCreatedBy(String createdBy) {
        this.createdBy = createdBy;
        return this;
    }
     ...
     */
    @Override
    public CardCatalogueGetClassCards setUri(String uri) {
        this.uri = uri;
        return this;
    }
     ...
     */
    @Override
    public CardCatalogueGetClassCards setBlocklyWorkspace(JsonObject blocklyWorkspace) {
        this.blocklyWorkspace = blocklyWorkspace;
        return this;
    }
     ...
     */
    @Override
    public CardCatalogueGetClassCards setCardScript(JsonObject cardScript) {
        this.cardScript = cardScript;
        return this;
    }
     ...
     */
    @Override
    public CardCatalogueGetClassCards setCreatedAt(OffsetDateTime createdAt) {
        this.createdAt = createdAt;
        return this;
    }
     ...
     */
    @Override
    public CardCatalogueGetClassCards setLastModified(OffsetDateTime lastModified) {
        this.lastModified = lastModified;
        return this;
    }
     ...
     */
    @Override
    public CardCatalogueGetClassCards setIsArchived(Boolean isArchived) {
        this.isArchived = isArchived;
        return this;
    }
     ...
     */
    @Override
    public CardCatalogueGetClassCards setIsPublished(Boolean isPublished) {
        this.isPublished = isPublished;
        return this;
    }
     ...
     */
    @Override
    public CardCatalogueGetClassCards setSuccession(Long succession) {
        this.succession = succession;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final CardCatalogueGetClassCards other = (CardCatalogueGetClassCards) obj;
        if (this.id == null) {
            if (other.id != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("CardCatalogueGetClassCards (");
