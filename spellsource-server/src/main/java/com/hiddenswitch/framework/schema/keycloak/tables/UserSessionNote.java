...
public class UserSessionNote extends TableImpl<UserSessionNoteRecord> {
    ...
    @Override
    public UserSessionNote as(Table<?> alias) {
        return new UserSessionNote(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public UserSessionNote rename(Table<?> name) {
        return new UserSessionNote(name.getQualifiedName(), null);
    }
