...
public class FederatedUser extends TableImpl<FederatedUserRecord> {
    ...
    @Override
    public FederatedUser as(Table<?> alias) {
        return new FederatedUser(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public FederatedUser rename(Table<?> name) {
        return new FederatedUser(name.getQualifiedName(), null);
    }
