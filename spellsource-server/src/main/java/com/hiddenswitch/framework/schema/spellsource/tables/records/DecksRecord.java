...
public class DecksRecord extends UpdatableRecordImpl<DecksRecord> implements VertxPojo, Record10<String, String, String, String, String, Boolean, String, Integer, Boolean, Boolean>, IDecks {
     ...
     */
    @Override
    public DecksRecord setDeckType(Integer value) {
        set(7, value);
        return this;
    }
     ...
     */
    @Override
    public DecksRecord setPermittedToDuplicate(Boolean value) {
        set(9, value);
        return this;
    }
    ...
    @Override
    public Row10<String, String, String, String, String, Boolean, String, Integer, Boolean, Boolean> valuesRow() {
    ...
    public Field<Integer> field8() {
        return Decks.DECKS.DECK_TYPE;
    }

    @Override
    public Field<Boolean> field9() {
        return Decks.DECKS.IS_PREMADE;
    }

    @Override
    public Field<Boolean> field10() {
        return Decks.DECKS.PERMITTED_TO_DUPLICATE;
    }
    ...
    public Boolean component10() {
        return getPermittedToDuplicate();
    }
    ...
    @Override
    public DecksRecord value8(Integer value) {
        setDeckType(value);
        return this;
    }

    @Override
    public DecksRecord value9(Boolean value) {
        setIsPremade(value);
        return this;
    }

    @Override
    public DecksRecord value10(Boolean value) {
        setPermittedToDuplicate(value);
        return this;
    }

    @Override
    public DecksRecord values(String value1, String value2, String value3, String value4, String value5, Boolean value6, String value7, Integer value8, Boolean value9, Boolean value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DecksRecord(String id, String createdBy, String lastEditedBy, String name, String heroClass, Boolean trashed, String format, Integer deckType, Boolean isPremade, Boolean permittedToDuplicate) {
        super(Decks.DECKS);
        ...
        setPermittedToDuplicate(permittedToDuplicate);
    }

    /**
     * Create a detached, initialised DecksRecord
     */
    public DecksRecord(com.hiddenswitch.framework.schema.spellsource.tables.pojos.Decks value) {
        super(Decks.DECKS);

        if (value != null) {
            setId(value.getId());
            setCreatedBy(value.getCreatedBy());
            setLastEditedBy(value.getLastEditedBy());
            setName(value.getName());
            setHeroClass(value.getHeroClass());
            setTrashed(value.getTrashed());
            setFormat(value.getFormat());
            setDeckType(value.getDeckType());
            setIsPremade(value.getIsPremade());
            setPermittedToDuplicate(value.getPermittedToDuplicate());
        }
    }
