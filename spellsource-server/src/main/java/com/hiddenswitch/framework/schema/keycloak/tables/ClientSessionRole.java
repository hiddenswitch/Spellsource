...
public class ClientSessionRole extends TableImpl<ClientSessionRoleRecord> {
    ...
    @Override
    public ClientSessionRole as(Table<?> alias) {
        return new ClientSessionRole(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public ClientSessionRole rename(Table<?> name) {
        return new ClientSessionRole(name.getQualifiedName(), null);
    }
