...
public class IdentityProviderRecord extends UpdatableRecordImpl<IdentityProviderRecord> implements VertxPojo, Record13<String, Boolean, String, String, Boolean, Boolean, String, Boolean, Boolean, String, String, String, Boolean>, IIdentityProvider {
    ...
    public IdentityProviderRecord(String internalId, Boolean enabled, String providerAlias, String providerId, Boolean storeToken, Boolean authenticateByDefault, String realmId, Boolean addTokenRole, Boolean trustEmail, String firstBrokerLoginFlowId, String postBrokerLoginFlowId, String providerDisplayName, Boolean linkOnly) {
        ...
        setAuthenticateByDefault(authenticateByDefault);
        setRealmId(realmId);
        setAddTokenRole(addTokenRole);
        setTrustEmail(trustEmail);
        setFirstBrokerLoginFlowId(firstBrokerLoginFlowId);
        setPostBrokerLoginFlowId(postBrokerLoginFlowId);
     ...
     * Create a detached, initialised IdentityProviderRecord
     */
    public IdentityProviderRecord(com.hiddenswitch.framework.schema.keycloak.tables.pojos.IdentityProvider value) {
        super(IdentityProvider.IDENTITY_PROVIDER);

        if (value != null) {
            setInternalId(value.getInternalId());
            setEnabled(value.getEnabled());
            setProviderAlias(value.getProviderAlias());
            setProviderId(value.getProviderId());
            setStoreToken(value.getStoreToken());
            setAuthenticateByDefault(value.getAuthenticateByDefault());
            setRealmId(value.getRealmId());
            setAddTokenRole(value.getAddTokenRole());
            setTrustEmail(value.getTrustEmail());
            setFirstBrokerLoginFlowId(value.getFirstBrokerLoginFlowId());
            setPostBrokerLoginFlowId(value.getPostBrokerLoginFlowId());
            setProviderDisplayName(value.getProviderDisplayName());
            setLinkOnly(value.getLinkOnly());
        }
    }
