...
public class Keys {
    ...
    public static final UniqueKey<CardsRecord> CARDS_PKEY = Internal.createUniqueKey(Cards.CARDS, DSL.name("cards_pkey"), new TableField[] { Cards.CARDS.SUCCESSION }, true);
    ...
    public static final UniqueKey<GeneratedArtRecord> GENERATED_ART_HASH_OWNER_KEY = Internal.createUniqueKey(GeneratedArt.GENERATED_ART, DSL.name("generated_art_hash_owner_key"), new TableField[] { GeneratedArt.GENERATED_ART.HASH, GeneratedArt.GENERATED_ART.OWNER }, true);
    ...
    public static final ForeignKey<GeneratedArtRecord, UserEntityRecord> GENERATED_ART__GENERATED_ART_OWNER_FKEY = Internal.createForeignKey(GeneratedArt.GENERATED_ART, DSL.name("generated_art_owner_fkey"), new TableField[] { GeneratedArt.GENERATED_ART.OWNER }, com.hiddenswitch.framework.schema.keycloak.Keys.CONSTRAINT_FB, new TableField[] { UserEntity.USER_ENTITY.ID }, true);
