...
public class WebOriginsRecord extends TableRecordImpl<WebOriginsRecord> implements VertxPojo, Record2<String, String>, IWebOrigins {
     ...
     * Create a detached, initialised WebOriginsRecord
     */
    public WebOriginsRecord(com.hiddenswitch.framework.schema.keycloak.tables.pojos.WebOrigins value) {
        super(WebOrigins.WEB_ORIGINS);
