...
public interface ICardCatalogueGetHardRemovalCards extends VertxPojo, Serializable {

    /**
     * Setter for
     * <code>spellsource.card_catalogue_get_hard_removal_cards.card_id</code>.
     */
    public ICardCatalogueGetHardRemovalCards setCardId(String value);
     ...
     * interface ICardCatalogueGetHardRemovalCards
     */
    ...
    public <E extends ICardCatalogueGetHardRemovalCards> E into(E into);
        ...
        @Override
        public default ICardCatalogueGetHardRemovalCards fromJson(io.vertx.core.json.JsonObject json) {
