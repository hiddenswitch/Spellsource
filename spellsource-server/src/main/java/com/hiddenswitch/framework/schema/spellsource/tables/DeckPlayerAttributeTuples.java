...
public class DeckPlayerAttributeTuples extends TableImpl<DeckPlayerAttributeTuplesRecord> {
    ...
    @Override
    public DeckPlayerAttributeTuples as(Table<?> alias) {
        return new DeckPlayerAttributeTuples(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public DeckPlayerAttributeTuples rename(Table<?> name) {
        return new DeckPlayerAttributeTuples(name.getQualifiedName(), null);
    }
