...
public class CardsRecord extends UpdatableRecordImpl<CardsRecord> implements VertxPojo, Record10<String, String, String, JsonObject, JsonObject, OffsetDateTime, OffsetDateTime, Boolean, Boolean, Long>, ICards {
     ...
     */
    @Override
    public CardsRecord setBlocklyWorkspace(JsonObject value) {
        set(3, value);
        return this;
    }
    ...
    @Override
    public CardsRecord value4(JsonObject value) {
    ...
    @Override
    public CardsRecord values(String value1, String value2, String value3, JsonObject value4, JsonObject value5, OffsetDateTime value6, OffsetDateTime value7, Boolean value8, Boolean value9, Long value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CardsRecord(String id, String createdBy, String uri, JsonObject blocklyWorkspace, JsonObject cardScript, OffsetDateTime createdAt, OffsetDateTime lastModified, Boolean isArchived, Boolean isPublished, Long succession) {
        super(Cards.CARDS);
