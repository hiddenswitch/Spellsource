...
public class CardsRecord extends UpdatableRecordImpl<CardsRecord> implements VertxPojo, Record9<String, String, String, XML, JsonObject, OffsetDateTime, OffsetDateTime, Boolean, Boolean>, ICards {
     ...
     */
    @Override
    public CardsRecord setIsPrivate(Boolean value) {
        set(8, value);
        return this;
    }
    ...
    @Override
    public CardsRecord values(String value1, String value2, String value3, XML value4, JsonObject value5, OffsetDateTime value6, OffsetDateTime value7, Boolean value8, Boolean value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CardsRecord(String id, String createdBy, String uri, XML blocklyWorkspace, JsonObject cardScript, OffsetDateTime createdAt, OffsetDateTime lastModified, Boolean isArchived, Boolean isPrivate) {
        super(Cards.CARDS);
