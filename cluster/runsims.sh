...
DECKS=$(ls | paste -s -d, -)
java -cp ../../../../../../cluster/build/libs/cluster-0.8.18-all.jar com.hiddenswitch.cluster.applications.Simulate --decks "${DECKS}" --number 10000 --output ../temporary_results.tsv
