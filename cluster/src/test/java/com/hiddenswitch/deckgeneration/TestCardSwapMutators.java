...
public class TestCardSwapMutators {
    ...
    public void smartSwapMutationTest() {
        ...
        MutatorResult<Chromosome<BitGene>> value = SimpleSmartSwapMutator.getSimpleSmartSwapMutatorResult(testChromosome, 1, random, indexInBitmap);
    ...
    public void simpleCardSwapMutationTest() {
        ...
        bits.flip(size - 1);
        Chromosome<BitGene> testChromosome = BitChromosome.of(bits);
        MutatorResult<Chromosome<BitGene>> value = SimpleCardSwapMutator.getSimpleCardSwapMutatorResult(testChromosome, 1, random);
    ...
    public void simpleCardSwapReturnsTest() {
        ...
        bits.flip(0);
        bits.flip(1);
        MutatorResult<Chromosome<BitGene>> value2 = SimpleCardSwapMutator.getSimpleCardSwapMutatorResult(testChromosome, 1, random);
