...
public class BitSwapBetweenTwoSequencesOnSpecificChromosomesMutator<
	...
	public BitSwapBetweenTwoSequencesOnSpecificChromosomesMutator(double probability, List<Integer> chromosomesToCrossover) {
