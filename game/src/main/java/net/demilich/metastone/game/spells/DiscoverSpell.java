 ...
 *      }
 * </pre>
 * To cast a discovered spell instead of receiving it, change the {@link SpellArg#SPELL} to a {@link PlayCardsSpell}. When
 * trying to do different effects with the chosen cards, it's important to check if the {@link Spell} supports the
 * {@link SpellArg#CARD} argument (common ones like {@link PlayCardsSpell}, {@link SummonSpell} and {@link
 * ReceiveCardSpell} do:
 * <pre>
 *      {
 *          "class": "DiscoverSpell",
