...
public class AttributeSerializer implements JsonDeserializer<AttributeMap>, JsonSerializer<AttributeMap> {
	...
	public AttributeMap deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context)
		...
		parseAttribute(Attribute.AI_OPPONENT, jsonData, map, ParseValueType.BOOLEAN);
		...
		parseAttribute(Attribute.KEEPS_ENCHANTMENTS, jsonData, map, ParseValueType.BOOLEAN);
		parseAttribute(Attribute.RECEIVED_ON_TURN, jsonData, map, ParseValueType.INTEGER);
		...
		parseAttribute(Attribute.AURA_TAUNT, jsonData, map, ParseValueType.BOOLEAN);
		parseAttribute(Attribute.AURA_IMMUNE, jsonData, map, ParseValueType.BOOLEAN);
