...
public abstract class Spell implements Serializable, HasDesc<SpellDesc> {
	...
	private static final Set<SpellArg> COMMON_ARGS = Sets.newEnumSet(
			Arrays.asList(SpellArg.CLASS, SpellArg.FILTER, SpellArg.TARGET, SpellArg.RANDOM_TARGET, SpellArg.TARGET_PLAYER, SpellArg.SPELL, SpellArg.BOARD_POSITION_RELATIVE), SpellArg.class);
