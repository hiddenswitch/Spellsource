...
public abstract class Spell implements Serializable, HasDesc<SpellDesc> {
	...
	private static final Set<SpellArg> COMMON_ARGS = EnumSet.of(
			SpellArg.CLASS, SpellArg.FILTER, SpellArg.TARGET, SpellArg.NAME, SpellArg.DESCRIPTION, SpellArg.RANDOM_TARGET, SpellArg.TARGET_PLAYER, SpellArg.SPELL, SpellArg.BOARD_POSITION_RELATIVE, SpellArg.BOARD_POSITION_ABSOLUTE, SpellArg.AFTERMATH_ID);
