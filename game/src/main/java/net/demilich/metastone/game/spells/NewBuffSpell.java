 ...
 */
public class NewBuffSpell extends Spell {

	private static Logger logger = LoggerFactory.getLogger(NewBuffSpell.class);

	public static SpellDesc create(EntityReference target, int value) {
		Map<SpellArg, Object> arguments = new SpellDesc(NewBuffSpell.class);
