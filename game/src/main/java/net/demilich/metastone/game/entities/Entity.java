...
public abstract class Entity extends CustomCloneable implements Serializable {
	 ...
	 * attributes that are "boolean" are just set to 1. Setting the value to 0 is not equivalent to not having the attribute.
	...
	/**
	 * Gets the {@link EntityLocation} of the entity, which includes its {@link EntityLocation#zone}, {@link EntityLocation#player}
	 * and {@link EntityLocation#index}.
	 * <p>
	 * @return The entity's location in the match encoded as a {@link EntityLocation}, or {@link EntityLocation#UNASSIGNED} if
	 * the entity has not yet been assigned a location or placed into an {@link EntityZone}.
	 ...
	 * Should not be called.
	 * <p>
	 * Resets the entity's location by setting it to {@link EntityLocation#UNASSIGNED}. Typically only called by an {@link EntityZone}.
	 */
