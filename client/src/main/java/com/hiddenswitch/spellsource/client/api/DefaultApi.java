...
public class DefaultApi {
    ...
    private com.squareup.okhttp.Call changePasswordCall(ChangePasswordRequest request, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/accounts-password".replaceAll("\\{format\\}","json");
    ...
    public ChangePasswordResponse changePassword(ChangePasswordRequest request) throws ApiException {
        ApiResponse<ChangePasswordResponse> resp = changePasswordWithHttpInfo(request);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ChangePasswordResponse> changePasswordWithHttpInfo(ChangePasswordRequest request) throws ApiException {
        com.squareup.okhttp.Call call = changePasswordCall(request, null, null);
     ...
     */
    public com.squareup.okhttp.Call changePasswordAsync(ChangePasswordRequest request, final ApiCallback<ChangePasswordResponse> callback) throws ApiException {
    ...
    private com.squareup.okhttp.Call healthCheckCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    public ApiResponse<Void> healthCheckWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = healthCheckCall(null, null);
        return apiClient.execute(call);
    }
