...
<summary>A new intro screen, updated fonts, and introducing the Witch class!</summary>
 ...
 - Imbue keyword: When you play the Fox (token) spells generated by the Witch class, you gain a charge. Spend these charges to gain the Imbue effect on other cards.
 - The friends list and invitations are re-enabled. If you are experiencing issues playing matches against your friends, please report the issue!
