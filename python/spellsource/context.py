...
class Context(contextlib.AbstractContextManager):
    ...
    @staticmethod
    def find_resource_path(filename='net-0.8.73-all.jar'):
        """
    ...
    def _start_gateway(port=0) -> JavaGateway:
        ...
        # server was bound to.
        hearthstone_jar_path = Context.find_resource_path('hearthstone-0.8.73.jar')
        net_jar_path = Context.find_resource_path('net-0.8.73-all.jar')
