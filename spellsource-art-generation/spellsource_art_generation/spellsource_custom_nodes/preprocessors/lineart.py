...
class LineArt_Preprocessor:
    ...
    def execute(self, image, **kwargs):
        from spellsource_preprocessors.controlnet_aux.lineart import LineartDetector

        model = LineartDetector.from_pretrained(HF_MODEL_NAME, cache_dir=annotator_ckpts_path).to(
