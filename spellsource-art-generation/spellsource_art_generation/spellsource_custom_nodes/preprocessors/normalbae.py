...
class BAE_Normal_Map_Preprocessor:
    ...
    def execute(self, image, **kwargs):
        from spellsource_preprocessors.controlnet_aux.normalbae import NormalBaeDetector

        model = NormalBaeDetector.from_pretrained(HF_MODEL_NAME, cache_dir=annotator_ckpts_path).to(
