...
class Uniformer_SemSegPreprocessor:
    ...
    def semantic_segmentate(self, image):
        from spellsource_preprocessors.controlnet_aux.uniformer import UniformerSegmentor

        model = UniformerSegmentor.from_pretrained(HF_MODEL_NAME, cache_dir=annotator_ckpts_path).to(
