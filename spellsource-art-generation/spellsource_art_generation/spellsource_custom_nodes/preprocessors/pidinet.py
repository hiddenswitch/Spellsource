...
class PIDINET_Preprocessor:
    ...
    def execute(self, image, safe, **kwargs):
        from spellsource_preprocessors.controlnet_aux.pidi import PidiNetDetector

        model = PidiNetDetector.from_pretrained(HF_MODEL_NAME, cache_dir=annotator_ckpts_path).to(
