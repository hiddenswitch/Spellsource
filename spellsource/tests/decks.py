...
DECK_3 = '''### Cubelock - Standard Meta Snapshot - May 9, 2018
        # Class: Warlock
        # Format: Standard
        # Year of the Raven
        #
...
DECK_4 = '''### Even Paladin - Standard Meta Snapshot - May 9, 2018
        # Class: Paladin
        # Format: Standard
        # Year of the Raven
        #
        ...
        # 1x (6) Val'anyr
        '''
DECK_5 = '''### Spiteful Druid - Standard Meta Snapshot - May 9, 2018
        # Class: Druid
        # Format: Standard
        # Year of the Raven
        #
...
DECK_6 = '''### Aggro Mage - Standard Meta Snapshot - Apr. 30, 2018
        # Class: Mage
        # Format: Standard
        # Year of the Raven
        #
